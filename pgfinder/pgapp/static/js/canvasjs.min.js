/*
 CanvasJS Chart - v3.7.21 GA - https://canvasjs.com/ 
...
[],b,e=0;e<a.length;e++)if(0==e)c.push(a[0]);else{var f,l,t;t=e-1;f=0===t?0:t-1;l=t===a.length-1?t:t+1;b=Math.abs((a[l].x-a[f].x)/(0===a[l].x-a[t].x?0.01:a[l].x-a[t].x))*(d-1)/2+1;var D=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[t].x>a[f].x&&0<D||a[t].x<a[f].x&&0>D?{x:a[t].x+D/3,y:a[t].y+b/3}:{x:a[t].x,y:a[t].y+b/9};t=e;f=0===t?0:t-1;l=t===a.length-1?t:t+1;b=Math.abs((a[l].x-a[f].x)/(0===a[t].x-a[f].x?0.01:a[t].x-a[f].x))*(d-1)/2+1;D=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[t].x>
a[f].x&&0<D||a[t].x<a[f].x&&0>D?{x:a[t].x-D/3,y:a[t].y-b/3}:{x:a[t].x,y:a[t].y-b/9};c[c.length]=a[e]}return c}function B(a,d,c,b,e,f,l,t,D,k){var m=0;k?(l.color=f,t.color=f):k=1;m=D?Math.abs(e-c):Math.abs(b-d);m=0<l.trimLength?Math.abs(m*l.trimLength/100):Math.abs(m-l.length);D?(c+=m/2,e-=m/2):(d+=m/2,b-=m/2);var m=1===Math.round(l.thickness)%2?0.5:0,p=1===Math.round(t.thickness)%2?0.5:0;a.save();a.globalAlpha=k;a.strokeStyle=t.color||f;a.lineWidth=t.thickness||2;a.setLineDash&&a.setLineDash(J(t.dashType,
t.thickness));a.beginPath();D&&0<t.thickness?(a.moveTo(b-l.thickness/2,Math.round((c+e)/2)-p),a.lineTo(d+l.thickness/2,Math.round((c+e)/2)-p)):0<t.thickness&&(a.moveTo(Math.round((d+b)/2)-p,c+l.thickness/2),a.lineTo(Math.round((d+b)/2)-p,e-l.thickness/2));a.stroke();a.strokeStyle=l.color||f;a.lineWidth=l.thickness||2;a.setLineDash&&a.setLineDash(J(l.dashType,l.thickness));a.beginPath();D&&0<l.thickness?(a.moveTo(b-m,c),a.lineTo(b-m,e),a.moveTo(d+m,c),a.lineTo(d+m,e)):0<l.thickness&&(a.moveTo(d,c+
...
0,0,this.width,this.height),this._preRenderCtx.drawImage(this._breaksCanvas,0,0,this.width,this.height),this._breaksCanvasCtx.globalCompositeOperation="source-atop",this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),this._preRenderCtx.clearRect(0,0,this.width,this.height));for(d=0;d<this.plotInfo.plotTypes.length;d++)for(var f=this.plotInfo.plotTypes[d],l=0;l<f.plotUnits.length;l++){var t=f.plotUnits[l],D=null;t.targetCanvas&&ya(t.targetCanvas);t.targetCanvas=null;this.animatedRender&&
...
this.animatedRender&&(t.targetCanvasCtx.miterLimit=e,D&&c.push(D))}this.ctx.miterLimit=a;this.animatedRender&&this._breaksCanvasCtx&&c.push({source:this._breaksCanvasCtx,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0,startTimePercent:0.7});this.animatedRender&&0<this._indexLabels.length&&(e=ua(this.width,this.height).getContext("2d"),c.push(this.renderIndexLabels(e)));var m=this;if(0<c.length)m.disableToolTip=!0,m._animator.animate(200,
...
"waterfall"===b.type&&this._processSpecificPlotUnit(b)}this.calculateAutoBreaks()};n.prototype._processMultiseriesPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=0;l<a.dataSeriesIndexes.length;l++){var t=this.data[a.dataSeriesIndexes[l]],D=0,k=!1,m=!1,p;if("normal"===t.axisPlacement||"xySwapped"===t.axisPlacement)var q=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:a.axisX.options&&
a.axisX.options.viewportMinimum?a.axisX.options.viewportMinimum:a.axisX.options&&a.axisX.options.minimum?a.axisX.options.minimum:a.axisX.logarithmic?0:-Infinity,g=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:a.axisX.options&&a.axisX.options.viewportMaximum?a.axisX.options.viewportMaximum:a.axisX.options&&a.axisX.options.maximum?a.axisX.options.maximum:Infinity;if(t.dataPoints[D].x&&t.dataPoints[D].x.getTime||"dateTime"===t.xValueType)f=!0;for(D=0;D<t.dataPoints.length;D++){"undefined"===
typeof t.dataPoints[D].x&&(t.dataPoints[D].x=D+(a.axisX.logarithmic?1:0));t.dataPoints[D].x.getTime?(f=!0,b=t.dataPoints[D].x.getTime()):b=t.dataPoints[D].x;e=t.dataPoints[D].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);e<d.min&&"number"===typeof e&&(d.min=e);e>d.max&&"number"===typeof e&&(d.max=e);if(0<D){if(a.axisX.logarithmic){var s=b/t.dataPoints[D-1].x;1>s&&(s=1/s);c.minDiff>s&&1!==s&&(c.minDiff=s)}else s=b-t.dataPoints[D-1].x,0>s&&(s*=-1),c.minDiff>s&&0!==s&&(c.minDiff=s);null!==e&&null!==t.dataPoints[D-
1].y&&(a.axisY.logarithmic?(s=e/t.dataPoints[D-1].y,1>s&&(s=1/s),d.minDiff>s&&1!==s&&(d.minDiff=s)):(s=e-t.dataPoints[D-1].y,0>s&&(s*=-1),d.minDiff>s&&0!==s&&(d.minDiff=s)))}if(b<q&&!k)null!==e&&(p=b);else{if(!k&&(k=!0,0<D)){D-=2;continue}if(b>g&&!m)m=!0;else if(b>g&&m)continue;t.dataPoints[D].label&&(a.axisX.labels[b]=t.dataPoints[D].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&p<b&&(c.viewPortMin=p):(e<d.viewPortMin&&"number"===typeof e&&
...
h):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l[b]?l[b]+=e:(l[b]=e,D=Math.min(e,D)):t[b]?t[b]+=e:(t[b]=e,k=Math.max(e,k)))}}a.axisY.scaleBreaks&&(a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks)&&(d.dataPointYPositiveSums?(d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums,l),d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums,t)):(d.dataPointYPositiveSums=l,d.dataPointYNegativeSums=
t));p.axisX.valueType=p.xValueType=f?"dateTime":"number"}for(q in l)l.hasOwnProperty(q)&&!isNaN(q)&&(a=l[q],a<d.min&&(d.min=Math.min(a,D)),a>d.max&&(d.max=a),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=Math.min(a,D)),a>d.viewPortMax&&(d.viewPortMax=a)));for(q in t)t.hasOwnProperty(q)&&!isNaN(q)&&(a=t[q],a<d.min&&(d.min=a),a>d.max&&(d.max=Math.max(a,k)),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=a),a>d.viewPortMax&&(d.viewPortMax=Math.max(a,k))))}};n.prototype._processStacked100PlotUnit=
...
u&&0!==u&&(d.minDiff=u)))}if(b<h&&!q)null!==e&&(s=b);else{if(!q&&(q=!0,0<p)){p-=2;continue}if(b>ba&&!g)g=!0;else if(b>ba&&g)continue;m.dataPoints[p].label&&(a.axisX.labels[b]=m.dataPoints[p].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&s<b&&(c.viewPortMin=s):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l=!0:0>e&&(t=!0),D[b]=D[b]?D[b]+Math.abs(e):Math.abs(e))}}m.axisX.valueType=
...
-1),d.min=r(d.viewPortMin)?-99:Math.min(d.viewPortMin,-99));d.viewPortMin=d.min;d.viewPortMax=d.max;a.dataPointYSums=D}};n.prototype._processMultiYPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f,l,t=!1,D=0;D<a.dataSeriesIndexes.length;D++){var k=this.data[a.dataSeriesIndexes[D]],m=0,p=!1,q=!1,g,s,h;if("normal"===k.axisPlacement||"xySwapped"===k.axisPlacement)var r=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:
...
a.axisX.options&&a.axisX.options.viewportMaximum?a.axisX.options.viewportMaximum:a.axisX.options&&a.axisX.options.maximum?a.axisX.options.maximum:Infinity;if(t.dataPoints[D].x&&t.dataPoints[D].x.getTime||"dateTime"===t.xValueType)f=!0;for(D=0;D<t.dataPoints.length;D++)"undefined"!==typeof t.dataPoints[D].isCumulativeSum&&!0===t.dataPoints[D].isCumulativeSum?(t.dataPointEOs[D].cumulativeSumYStartValue=0,t.dataPointEOs[D].cumulativeSum=0===D?0:t.dataPointEOs[D-1].cumulativeSum,t.dataPoints[D].y=0===
D?0:t.dataPointEOs[D-1].cumulativeSum):"undefined"!==typeof t.dataPoints[D].isIntermediateSum&&!0===t.dataPoints[D].isIntermediateSum?(t.dataPointEOs[D].cumulativeSumYStartValue=p,t.dataPointEOs[D].cumulativeSum=0===D?0:t.dataPointEOs[D-1].cumulativeSum,t.dataPoints[D].y=0===D?0:b,p=0===D?0:t.dataPointEOs[D-1].cumulativeSum,b=0):(e="number"!==typeof t.dataPoints[D].y?0:t.dataPoints[D].y,t.dataPointEOs[D].cumulativeSumYStartValue=0===D?0:t.dataPointEOs[D-1].cumulativeSum,t.dataPointEOs[D].cumulativeSum=
0===D?e:t.dataPointEOs[D-1].cumulativeSum+e,b+=e);for(D=0;D<t.dataPoints.length;D++)if("undefined"===typeof t.dataPoints[D].x&&(t.dataPoints[D].x=D+(a.axisX.logarithmic?1:0)),t.dataPoints[D].x.getTime?(f=!0,b=t.dataPoints[D].x.getTime()):b=t.dataPoints[D].x,e=t.dataPoints[D].y,b<c.min&&(c.min=b),b>c.max&&(c.max=b),t.dataPointEOs[D].cumulativeSum<d.min&&(d.min=t.dataPointEOs[D].cumulativeSum),t.dataPointEOs[D].cumulativeSum>d.max&&(d.max=t.dataPointEOs[D].cumulativeSum),0<D&&(a.axisX.logarithmic?(p=
b/t.dataPoints[D-1].x,1>p&&(p=1/p),c.minDiff>p&&1!==p&&(c.minDiff=p)):(p=b-t.dataPoints[D-1].x,0>p&&(p*=-1),c.minDiff>p&&0!==p&&(c.minDiff=p)),null!==e&&null!==t.dataPoints[D-1].y&&(a.axisY.logarithmic?(e=t.dataPointEOs[D].cumulativeSum/t.dataPointEOs[D-1].cumulativeSum,1>e&&(e=1/e),d.minDiff>e&&1!==e&&(d.minDiff=e)):(e=t.dataPointEOs[D].cumulativeSum-t.dataPointEOs[D-1].cumulativeSum,0>e&&(e*=-1),d.minDiff>e&&0!==e&&(d.minDiff=e)))),!(b<q)||k){if(!k&&(k=!0,0<D)){D-=2;continue}if(b>g&&!m)m=!0;else if(b>
g&&m)continue;t.dataPoints[D].label&&(a.axisX.labels[b]=t.dataPoints[D].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);0<D&&(t.dataPointEOs[D-1].cumulativeSum<d.viewPortMin&&(d.viewPortMin=t.dataPointEOs[D-1].cumulativeSum),t.dataPointEOs[D-1].cumulativeSum>d.viewPortMax&&(d.viewPortMax=t.dataPointEOs[D-1].cumulativeSum));t.dataPointEOs[D].cumulativeSum<d.viewPortMin&&(d.viewPortMin=t.dataPointEOs[D].cumulativeSum);t.dataPointEOs[D].cumulativeSum>d.viewPortMax&&(d.viewPortMax=
...
D)/b);p<m[g].min&&(m[g].min=p);p>m[g].max&&(m[g].max=p)}delete this._axes[l].dataInfo.dataPointYPositiveSums}if(this._axes[l].dataInfo.dataPointYNegativeSums){q=this._axes[l].dataInfo.dataPointYNegativeSums;m=k;for(t in q)q.hasOwnProperty(t)&&!isNaN(t)&&(p=-1*q[t],r(p)||(g=Math.floor((p-D)/b),p<m[g].min&&(m[g].min=p),p>m[g].max&&(m[g].max=p)));delete this._axes[l].dataInfo.dataPointYNegativeSums}for(t=0;t<k.length-1;t++)if(m=k[t].max,isFinite(m))for(;t<k.length-1;)if(D=k[t+1].min,isFinite(D)){p=D-
m;p>b&&f.push({diff:p,start:m,end:D});break}else t++;if(this._axes[l].scaleBreaks.customBreaks)for(t=0;t<this._axes[l].scaleBreaks.customBreaks.length;t++)for(b=0;b<f.length;b++)if(this._axes[l].scaleBreaks.customBreaks[t].startValue<=f[b].start&&f[b].start<=this._axes[l].scaleBreaks.customBreaks[t].endValue||this._axes[l].scaleBreaks.customBreaks[t].startValue<=f[b].start&&f[b].start<=this._axes[l].scaleBreaks.customBreaks[t].endValue||f[b].start<=this._axes[l].scaleBreaks.customBreaks[t].startValue&&
...
source:"chart",index:this.stockChart.charts.indexOf(this),minimum:e.val1,maximum:e.val2});return a.isValid};n.prototype.validateRegion=function(a,d,c,b,e){e=e||!1;for(var f=0<=this.zoomType.indexOf("x"),l=0<=this.zoomType.indexOf("y"),t=!1,D=[],k=[],m=[],p=0;p<this._axes.length;p++)("axisX"===this._axes[p].type&&f||"axisY"===this._axes[p].type&&l)&&k.push(this._axes[p]);for(l=0;l<k.length;l++){var p=k[l],f=!1,q=p.convertPixelToValue({x:a,y:d}),g=p.convertPixelToValue({x:c,y:b});if(q>g)var s=g,g=q,
q=s;if(p.scaleBreaks)for(s=0;!f&&s<p.scaleBreaks._appliedBreaks.length;s++)f=p.scaleBreaks._appliedBreaks[s].startValue<=q&&p.scaleBreaks._appliedBreaks[s].endValue>=g;if(isFinite(p.dataInfo.minDiff))if(s=p.getApparentDifference(q,g,null,!0),!(f||!(this.panEnabled&&p.scaleBreaks&&p.scaleBreaks._appliedBreaks.length)&&(p.logarithmic&&s<Math.pow(p.dataInfo.minDiff,3)||!p.logarithmic&&s<3*Math.abs(p.dataInfo.minDiff))||q<p.minimum||g>p.maximum))D.push(p),m.push({val1:q,val2:g}),t=!0;else if(!e){t=!1;
break}}return{isValid:t,axesWithValidRange:D,axesRanges:m}};n.prototype.preparePlotArea=function(){var a=this.plotArea;!w&&(0<a.x1||0<a.y1)&&a.ctx.translate(a.x1,a.y1);if((this.axisX[0]||this.axisX2[0])&&(this.axisY[0]||this.axisY2[0])){var d=this.axisX[0]?this.axisX[0].lineCoordinates:this.axisX2[0].lineCoordinates;if(this.axisY&&0<this.axisY.length&&this.axisY[0]){var c=this.axisY[0];a.x1=d.x1<d.x2?d.x1:c.lineCoordinates.x1;a.y1=d.y1<c.lineCoordinates.y1?d.y1:c.lineCoordinates.y1;a.x2=d.x2>c.lineCoordinates.x2?
...
a.height=d.height;w||(a.canvas.width=a.width,a.canvas.height=a.height,a.canvas.style.left=a.x1+"px",a.canvas.style.top=a.y1+"px",(0<a.x1||0<a.y1)&&a.ctx.translate(-a.x1,-a.y1));a.layoutManager=new Fa(a.x1,a.y1,a.x2,a.y2,2)};n.prototype.renderIndexLabels=function(a){var d=a||this.plotArea.ctx,c=this.plotArea,b=0,e=0,f=0,l=f=e=0,t=0,D=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var m=this._indexLabels[a],p=m.chartType.toLowerCase(),q,g,l=ma("indexLabelFontColor",m.dataPoint,m.dataSeries),s=ma("indexLabelFontSize",
m.dataPoint,m.dataSeries),t=ma("indexLabelFontFamily",m.dataPoint,m.dataSeries),D=ma("indexLabelFontStyle",m.dataPoint,m.dataSeries),k=ma("indexLabelFontWeight",m.dataPoint,m.dataSeries),h=ma("indexLabelBackgroundColor",m.dataPoint,m.dataSeries);q=ma("indexLabelMaxWidth",m.dataPoint,m.dataSeries);g=ma("indexLabelWrap",m.dataPoint,m.dataSeries);var ba=ma("indexLabelLineDashType",m.dataPoint,m.dataSeries),u=ma("indexLabelLineColor",m.dataPoint,m.dataSeries),n=r(m.dataPoint.indexLabelLineThickness)?
...
H&&""!==H){var x=ma("indexLabelPlacement",m.dataPoint,m.dataSeries),z=ma("indexLabelOrientation",m.dataPoint,m.dataSeries),C=ma("indexLabelTextAlign",m.dataPoint,m.dataSeries),v=m.direction,e=m.dataSeries.axisX,f=m.dataSeries.axisY,A=!1,h=new ja(d,{x:0,y:0,maxWidth:q?q:0.5*this.width,maxHeight:g?5*s:1.5*s,angle:"horizontal"===z?0:-90,text:H,padding:0,backgroundColor:h,textAlign:C,fontSize:s,fontFamily:t,fontWeight:k,fontColor:l,fontStyle:D,textBaseline:"middle"});h.measureText();m.dataSeries.indexLabelMaxWidth=
...
D:D-s/2)-l-b,q<e&&(q="auto"===x?Math.max(m.point.x,e)+l:e+l,A=q+D>m.point.x)):(q=m.point.x+("horizontal"===z?0:s/2)+l+b,q>f-D-l-b&&(q="auto"===x?Math.min(m.point.x,f)-("horizontal"===z?D:D/2)-l:f-D-l,A=q<m.point.x))):(e=Math.max(m.bounds.x1,c.x1),Math.min(m.bounds.x2,c.x2),b=0<=p.indexOf("range")||"error"===p?0>v?Math.max(m.bounds.x1,c.x1)+s/2+l:Math.min(m.bounds.x2,c.x2)-D/2-l+("horizontal"===z?0:s/2):(Math.max(m.bounds.x1,c.x1)+Math.min(m.bounds.x2,c.x2))/2+("horizontal"===z?0:s/2),q=0>v?Math.max(m.point.x,
...
(0<m.direction?-l:D+l)+("vertical"===z?-s/2:0),g+("vertical"===z?-k/2:k/2-s/2)-t):0<=p.indexOf("column")||"error"===p&&!m.axisSwapped?d.lineTo(q+D/2-("horizontal"===z?0:s/2),g+("vertical"===z?(g-k<m.point.y?0:-k)+t:(g-s/2<m.point.y?k:0)-s/2)):d.lineTo(q+D/2-("horizontal"===z?0:s/2),g+("vertical"===z?g-k<m.point.y?0:-k:(g-s/2<m.point.y?k:0)-s/2)),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0,startTimePercent:0.7};
...
a.dataSeriesIndexes[t],k=this.data[D];c.lineWidth=k.lineThickness;var m=k.dataPoints,p="solid";if(c.setLineDash){var q=J(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=J(p,k.lineThickness);c.setLineDash(g)}var s=k.id;this._eventManager.objectMap[s]={objectType:"dataSeries",dataSeriesIndex:D};s=X(s);b.strokeStyle=s;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var s=k._colorSet,h=s=k.lineColor=k.options.lineColor?k.options.lineColor:s[0];c.strokeStyle=s;var r=!0,u=0,n,x;c.beginPath();
if(0<m.length){for(var z=!1,u=0;u<m.length;u++)if(n=m[u].x.getTime?m[u].x.getTime():m[u].x,!(n<a.axisX.dataInfo.viewPortMin||n>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!z)))if("number"!==typeof m[u].y)0<u&&!(k.connectNullData||z||r)&&(c.stroke(),w&&b.stroke()),z=!0;else{n=a.axisX.convertValueToPixel(n);x=a.axisY.convertValueToPixel(m[u].y);var H=k.dataPointIds[u];this._eventManager.objectMap[H]={id:H,objectType:"dataPoint",dataSeriesIndex:D,dataPointIndex:u,x1:n,y1:x};r||z?(!r&&k.connectNullData?
(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(n,x),w&&b.lineTo(n,x)):(c.beginPath(),c.moveTo(n,x),w&&(b.beginPath(),b.moveTo(n,x))),z=r=!1):(c.lineTo(n,x),w&&b.lineTo(n,x),0==u%500&&(c.stroke(),c.beginPath(),c.moveTo(n,x),w&&(b.stroke(),b.beginPath(),b.moveTo(n,x))));l={x:n,y:x};u<m.length-1&&(h!==(m[u].lineColor||s)||p!==(m[u].lineDashType||
k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(n,x),h=m[u].lineColor||s,c.strokeStyle=h,c.setLineDash&&(m[u].lineDashType?(p=m[u].lineDashType,c.setLineDash(J(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0!==m[u].markerSize&&(0<m[u].markerSize||0<k.markerSize)){var C=k.getMarkerProperties(u,n,x,c);f.push(C);H=X(H);w&&f.push({x:n,y:x,ctx:b,type:C.type,size:C.size,color:H,borderColor:H,borderThickness:C.borderThickness})}(m[u].indexLabel||k.indexLabel||m[u].indexLabelFormatter||
k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:m[u],dataSeries:k,point:{x:n,y:x},direction:0>m[u].y===a.axisY.reversed?1:-1,color:s})}c.stroke();w&&b.stroke()}}W.drawMarkers(f);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),b.beginPath());c.restore();c.beginPath();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderStepLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var f=
[],l,t=0;t<a.dataSeriesIndexes.length;t++){var D=a.dataSeriesIndexes[t],k=this.data[D];c.lineWidth=k.lineThickness;var m=k.dataPoints,p="solid";if(c.setLineDash){var q=J(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=J(p,k.lineThickness);c.setLineDash(g)}var s=k.id;this._eventManager.objectMap[s]={objectType:"dataSeries",dataSeriesIndex:D};s=X(s);b.strokeStyle=s;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var s=k._colorSet,h=s=k.lineColor=k.options.lineColor?k.options.lineColor:
s[0];c.strokeStyle=s;var r=!0,u=0,n,x;c.beginPath();if(0<m.length){for(var z=!1,u=0;u<m.length;u++)if(n=m[u].getTime?m[u].x.getTime():m[u].x,!(n<a.axisX.dataInfo.viewPortMin||n>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!z)))if("number"!==typeof m[u].y)0<u&&!(k.connectNullData||z||r)&&(c.stroke(),w&&b.stroke()),z=!0;else{var H=x;n=a.axisX.convertValueToPixel(n);x=a.axisY.convertValueToPixel(m[u].y);var C=k.dataPointIds[u];this._eventManager.objectMap[C]={id:C,objectType:"dataPoint",dataSeriesIndex:D,
dataPointIndex:u,x1:n,y1:x};r||z?(!r&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(n,H),c.lineTo(n,x),w&&(b.lineTo(n,H),b.lineTo(n,x))):(c.beginPath(),c.moveTo(n,x),w&&(b.beginPath(),b.moveTo(n,x))),z=r=!1):(c.lineTo(n,H),w&&b.lineTo(n,H),c.lineTo(n,x),w&&b.lineTo(n,x),0==u%500&&(c.stroke(),c.beginPath(),c.moveTo(n,x),w&&
(b.stroke(),b.beginPath(),b.moveTo(n,x))));l={x:n,y:x};u<m.length-1&&(h!==(m[u].lineColor||s)||p!==(m[u].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(n,x),h=m[u].lineColor||s,c.strokeStyle=h,c.setLineDash&&(m[u].lineDashType?(p=m[u].lineDashType,c.setLineDash(J(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));0!==m[u].markerSize&&(0<m[u].markerSize||0<k.markerSize)&&(H=k.getMarkerProperties(u,n,x,c),f.push(H),C=X(C),w&&f.push({x:n,y:x,ctx:b,type:H.type,size:H.size,
color:C,borderColor:C,borderThickness:H.borderThickness}));(m[u].indexLabel||k.indexLabel||m[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:m[u],dataSeries:k,point:{x:n,y:x},direction:0>m[u].y===a.axisY.reversed?1:-1,color:s})}c.stroke();w&&b.stroke()}}W.drawMarkers(f);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),
a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),b.beginPath());c.restore();c.beginPath();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderSpline=function(a){function d(a){a=v(a,2);if(0<a.length){b.beginPath();w&&e.beginPath();b.moveTo(a[0].x,
...
a[c+3].newLineDashArray&&b.setLineDash(a[c+3].newLineDashArray),w&&(e.stroke(),e.beginPath(),e.moveTo(a[c+3].x,a[c+3].y));b.stroke();w&&e.stroke()}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx;b.save();var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var l=[],t=0;t<a.dataSeriesIndexes.length;t++){var D=a.dataSeriesIndexes[t],k=this.data[D];b.lineWidth=k.lineThickness;var m=
k.dataPoints,p="solid";if(b.setLineDash){var q=J(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=J(p,k.lineThickness);b.setLineDash(g)}var s=k.id;this._eventManager.objectMap[s]={objectType:"dataSeries",dataSeriesIndex:D};s=X(s);e.strokeStyle=s;e.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var s=k._colorSet,h=s=k.lineColor=k.options.lineColor?k.options.lineColor:s[0];b.strokeStyle=s;var r=0,u,n,x=[];b.beginPath();if(0<m.length)for(n=!1,r=0;r<m.length;r++)if(u=m[r].getTime?
m[r].x.getTime():m[r].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!n)))if("number"!==typeof m[r].y)0<r&&!n&&(k.connectNullData?b.setLineDash&&(0<x.length&&(k.options.nullDataLineDashType||!m[r-1].lineDashType))&&(x[x.length-1].newLineDashArray=q,p=k.nullDataLineDashType):(d(x),x=[])),n=!0;else{u=a.axisX.convertValueToPixel(u);n=a.axisY.convertValueToPixel(m[r].y);var z=k.dataPointIds[r];this._eventManager.objectMap[z]={id:z,objectType:"dataPoint",dataSeriesIndex:D,
dataPointIndex:r,x1:u,y1:n};x[x.length]={x:u,y:n};r<m.length-1&&(h!==(m[r].lineColor||s)||p!==(m[r].lineDashType||k.lineDashType))&&(h=m[r].lineColor||s,x[x.length-1].newStrokeStyle=h,b.setLineDash&&(m[r].lineDashType?(p=m[r].lineDashType,x[x.length-1].newLineDashArray=J(p,k.lineThickness)):(p=k.lineDashType,x[x.length-1].newLineDashArray=g)));if(0!==m[r].markerSize&&(0<m[r].markerSize||0<k.markerSize)){var H=k.getMarkerProperties(r,u,n,b);l.push(H);z=X(z);w&&l.push({x:u,y:n,ctx:e,type:H.type,size:H.size,
color:z,borderColor:z,borderThickness:H.borderThickness})}(m[r].indexLabel||k.indexLabel||m[r].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:m[r],dataSeries:k,point:{x:u,y:n},direction:0>m[r].y===a.axisY.reversed?1:-1,color:s});n=!1}d(x)}W.drawMarkers(l);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(f.x1,f.y1,f.width,f.height),e.beginPath());b.restore();b.beginPath();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=
null,e=this.plotArea,f=0,l,t,D,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,m=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.width,0.9*(this.plotArea.width/a.plotType.totalDataSeries))<<0,p=a.axisX.dataInfo.minDiff;isFinite(p)||(p=0.3*Math.abs(a.axisX.range));p=this.dataPointWidth=this.options.dataPointWidth?
this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(p)/Math.log(a.axisX.range):Math.abs(p)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&f>m&&(f=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<f)&&(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));p<f&&(p=f);p>m&&(p=m);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);
c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(m=0;m<a.dataSeriesIndexes.length;m++){var q=a.dataSeriesIndexes[m],g=this.data[q],s=g.dataPoints;if(0<s.length)for(var h=5<p&&g.bevelEnabled?!0:!1,f=0;f<s.length;f++)if(s[f].getTime?D=s[f].x.getTime():D=s[f].x,!(D<a.axisX.dataInfo.viewPortMin||D>a.axisX.dataInfo.viewPortMax)&&"number"===typeof s[f].y){l=a.axisX.convertValueToPixel(D);t=a.axisY.convertValueToPixel(s[f].y);
l=a.axisX.reversed?l+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+m)*p<<0:l-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+m)*p<<0;var r=a.axisX.reversed?l-p<<0:l+p<<0,u;0<=s[f].y?u=k:(u=t,t=k);t>u&&(b=t,t=u,u=b);b=s[f].color?s[f].color:g._colorSet[f%g._colorSet.length];Y(c,a.axisX.reversed?r:l,t,a.axisX.reversed?l:r,u,b,0,null,h&&(a.axisY.reversed?0>s[f].y:0<=s[f].y),(a.axisY.reversed?0<=s[f].y:0>s[f].y)&&h,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]=
{id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:t,x2:r,y2:u};b=X(b);w&&Y(this._eventManager.ghostCtx,a.axisX.reversed?r:l,t,a.axisX.reversed?l:r,u,b,0,null,!1,!1,!1,!1);(s[f].indexLabel||g.indexLabel||s[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:s[f],dataSeries:g,point:{x:l+(r-l)/2,y:0>s[f].y===a.axisY.reversed?t:u},direction:0>s[f].y===a.axisY.reversed?1:-1,bounds:{x1:l,y1:Math.min(t,u),x2:r,y2:Math.max(t,u)},color:b})}}w&&
(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.yScaleAnimation,
easingFunction:M.easing.easeOutQuart,animationBase:k<a.axisY.bounds.y1?a.axisY.bounds.y1:k>a.axisY.bounds.y2?a.axisY.bounds.y2:k}}};n.prototype.renderStackedColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],l=[],t=[],D=[],k=0,m,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:
1,g=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.width<<0,s=a.axisX.dataInfo.minDiff;isFinite(s)||(s=0.3*Math.abs(a.axisX.range));s=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(s)/Math.log(a.axisX.range):Math.abs(s)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&k>g&&(k=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,g));!this.dataPointMaxWidth&&
(this.dataPointMinWidth&&g<k)&&(g=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));s<k&&(s=k);s>g&&(s=g);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(g=0;g<a.dataSeriesIndexes.length;g++){var h=a.dataSeriesIndexes[g],r=this.data[h],u=r.dataPoints;if(0<u.length){var n=5<s&&r.bevelEnabled?
!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){m=a.axisX.convertValueToPixel(b);m=m-a.plotType.plotUnits.length*s/2+a.index*s<<0;var x=m+s<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y)t[b]=u[k].y+(t[b]?t[b]:0),0<t[b]&&(p=a.axisY.convertValueToPixel(t[b]),z="undefined"!==typeof f[b]?f[b]:q,f[b]=p);
else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)D[b]=u[k].y+(D[b]?D[b]:0),z=a.axisY.convertValueToPixel(D[b]),p="undefined"!==typeof l[b]?l[b]:q,l[b]=z;else if(p=a.axisY.convertValueToPixel(u[k].y),0<=u[k].y){var H="undefined"!==typeof f[b]?f[b]:0;p-=H;z=q-H;f[b]=H+(z-p)}else H=l[b]?l[b]:0,z=p+H,p=q+H,l[b]=H+(z-p);b=u[k].color?u[k].color:r._colorSet[k%r._colorSet.length];Y(c,m,a.axisY.reversed?z:p,x,a.axisY.reversed?p:z,b,0,null,n&&(a.axisY.reversed?0>u[k].y:0<=
u[k].y),(a.axisY.reversed?0<=u[k].y:0>u[k].y)&&n,!1,!1,r.fillOpacity);b=r.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:m,y1:p,x2:x,y2:z};b=X(b);w&&Y(this._eventManager.ghostCtx,m,p,x,z,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||r.indexLabel||u[k].indexLabelFormatter||r.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:u[k],dataSeries:r,point:{x:m+(x-m)/2,y:0<=u[k].y?p:z},direction:0>u[k].y===a.axisY.reversed?
1:-1,bounds:{x1:m,y1:Math.min(p,z),x2:x,y2:Math.max(p,z)},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};n.prototype.renderStackedColumn100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],l=[],t=[],D=[],k=0,m,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),
k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,g=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.width<<0,s=a.axisX.dataInfo.minDiff;isFinite(s)||(s=0.3*Math.abs(a.axisX.range));s=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(s)/Math.log(a.axisX.range):Math.abs(s)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&
...
a.dataSeriesIndexes[g],r=this.data[h],u=r.dataPoints;if(0<u.length)for(var n=5<s&&r.bevelEnabled?!0:!1,k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){m=a.axisX.convertValueToPixel(b);p=0!==a.dataPointYSums[b]?100*(u[k].y/a.dataPointYSums[b]):0;m=m-a.plotType.plotUnits.length*s/2+a.index*s<<0;var x=m+s<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&
...
typeof l[b]?l[b]:0,z=p+H,p=q+H,a.dataSeriesIndexes.length-1===g&&1>=Math.abs(e.y2-z)&&(z=e.y2),l[b]=H+(z-p);b=u[k].color?u[k].color:r._colorSet[k%r._colorSet.length];Y(c,m,a.axisY.reversed?z:p,x,a.axisY.reversed?p:z,b,0,null,n&&(a.axisY.reversed?0>u[k].y:0<=u[k].y),(a.axisY.reversed?0<=u[k].y:0>u[k].y)&&n,!1,!1,r.fillOpacity);b=r.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:m,y1:p,x2:x,y2:z};b=X(b);w&&Y(this._eventManager.ghostCtx,
m,p,x,z,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||r.indexLabel||u[k].indexLabelFormatter||r.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn100",dataPoint:u[k],dataSeries:r,point:{x:m+(x-m)/2,y:0<=u[k].y?p:z},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:m,y1:Math.min(p,z),x2:x,y2:Math.max(p,z)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,
this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};n.prototype.renderBar=
...
0,p=a.axisX.dataInfo.minDiff;isFinite(p)||(p=0.3*Math.abs(a.axisX.range));p=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(p)/Math.log(a.axisX.range):Math.abs(p)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&f>m&&(f=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<f)&&(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));p<f&&(p=
f);p>m&&(p=m);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(m=0;m<a.dataSeriesIndexes.length;m++){var q=a.dataSeriesIndexes[m],g=this.data[q],s=g.dataPoints;if(0<s.length){var h=5<p&&g.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(f=0;f<s.length;f++)if(s[f].getTime?D=s[f].x.getTime():D=s[f].x,!(D<
a.axisX.dataInfo.viewPortMin||D>a.axisX.dataInfo.viewPortMax)&&"number"===typeof s[f].y){t=a.axisX.convertValueToPixel(D);l=a.axisY.convertValueToPixel(s[f].y);t=a.axisX.reversed?t+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+m)*p<<0:t-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+m)*p<<0;var r=a.axisX.reversed?t-p<<0:t+p<<0,u;0<=s[f].y?u=k:(u=l,l=k);b=s[f].color?s[f].color:g._colorSet[f%g._colorSet.length];Y(c,a.axisY.reversed?l:u,a.axisX.reversed?r:t,a.axisY.reversed?u:
l,a.axisX.reversed?t:r,b,0,null,h,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:u,y1:t,x2:l,y2:r};b=X(b);w&&Y(this._eventManager.ghostCtx,u,a.axisX.reversed?r:t,l,a.axisX.reversed?t:r,b,0,null,!1,!1,!1,!1);(s[f].indexLabel||g.indexLabel||s[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"bar",dataPoint:s[f],dataSeries:g,point:{x:0<=s[f].y?l:u,y:t+(r-t)/2},direction:0>
s[f].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(u,l),y1:t,x2:Math.max(u,l),y2:r},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),
this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:k<a.axisY.bounds.x1?a.axisY.bounds.x1:k>a.axisY.bounds.x2?a.axisY.bounds.x2:k}}};n.prototype.renderStackedBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],l=[],t=[],D=[],k=0,m,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?
a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,g=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.height<<0,s=a.axisX.dataInfo.minDiff;isFinite(s)||(s=0.3*Math.abs(a.axisX.range));s=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(s)/Math.log(a.axisX.range):Math.abs(s)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<
0;this.dataPointMaxWidth&&k>g&&(k=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,g));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&g<k)&&(g=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));s<k&&(s=k);s>g&&(s=g);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());
for(g=0;g<a.dataSeriesIndexes.length;g++){var h=a.dataSeriesIndexes[g],r=this.data[h],u=r.dataPoints;if(0<u.length){var n=5<s&&r.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){p=a.axisX.convertValueToPixel(b);p=p-a.plotType.plotUnits.length*s/2+a.index*s<<0;var x=p+s<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&
0<u[k].y)t[b]=u[k].y+(t[b]?t[b]:0),0<t[b]&&(z=f[b]?f[b]:q,f[b]=m=a.axisY.convertValueToPixel(t[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)D[b]=u[k].y+(D[b]?D[b]:0),m=l[b]?l[b]:q,l[b]=z=a.axisY.convertValueToPixel(D[b]);else if(m=a.axisY.convertValueToPixel(u[k].y),0<=u[k].y){var H=f[b]?f[b]:0;z=q+H;m+=H;f[b]=H+(m-z)}else H=l[b]?l[b]:0,z=m-H,m=q-H,l[b]=H+(m-z);b=u[k].color?u[k].color:r._colorSet[k%r._colorSet.length];Y(c,a.axisY.reversed?m:z,p,a.axisY.reversed?
z:m,x,b,0,null,n,!1,!1,!1,r.fillOpacity);b=r.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:z,y1:p,x2:m,y2:x};b=X(b);w&&Y(this._eventManager.ghostCtx,z,p,m,x,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||r.indexLabel||u[k].indexLabelFormatter||r.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",dataPoint:u[k],dataSeries:r,point:{x:0<=u[k].y?m:z,y:p+(x-p)/2},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(z,
m),y1:p,x2:Math.max(z,m),y2:x},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();
return{source:d,dest:this.plotArea.ctx,animationCallback:M.xScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};n.prototype.renderStackedBar100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],l=[],t=[],D=[],k=0,m,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?
...
r=this.data[h],u=r.dataPoints;if(0<u.length){var n=5<s&&r.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){p=a.axisX.convertValueToPixel(b);var x;x=0!==a.dataPointYSums[b]?100*(u[k].y/a.dataPointYSums[b]):0;p=p-a.plotType.plotUnits.length*s/2+a.index*s<<0;var z=p+s<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&
0<u[k].y){t[b]=x+(t[b]?t[b]:0);if(0>=t[b])continue;x=f[b]?f[b]:q;f[b]=m=a.axisY.convertValueToPixel(t[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)D[b]=x+(D[b]?D[b]:0),m=l[b]?l[b]:q,l[b]=x=a.axisY.convertValueToPixel(D[b]);else if(m=a.axisY.convertValueToPixel(x),0<=u[k].y){var H=f[b]?f[b]:0;x=q+H;m+=H;a.dataSeriesIndexes.length-1===g&&1>=Math.abs(e.x2-m)&&(m=e.x2);f[b]=H+(m-x)}else H=l[b]?l[b]:0,x=m-H,m=q-H,a.dataSeriesIndexes.length-1===g&&1>=Math.abs(e.x1-
x)&&(x=e.x1),l[b]=H+(m-x);b=u[k].color?u[k].color:r._colorSet[k%r._colorSet.length];Y(c,a.axisY.reversed?m:x,p,a.axisY.reversed?x:m,z,b,0,null,n,!1,!1,!1,r.fillOpacity);b=r.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:x,y1:p,x2:m,y2:z};b=X(b);w&&Y(this._eventManager.ghostCtx,x,p,m,z,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||r.indexLabel||u[k].indexLabelFormatter||r.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",
dataPoint:u[k],dataSeries:r,point:{x:0<=u[k].y?m:x,y:p+(z-p)/2},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(x,m),y1:p,x2:Math.max(x,m),y2:z},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};n.prototype.renderArea=function(a){var d,c;function b(){H&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?z=x:0>a.axisY.viewportMaximum?
z=t.y1:0<a.axisY.viewportMinimum&&(z=x),f.lineTo(r,z),f.lineTo(H.x,z),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,w&&(l.lineTo(r,z),l.lineTo(H.x,z),l.closePath(),l.fill()),f.beginPath(),f.moveTo(r,u),l.beginPath(),l.moveTo(r,u),H={x:r,y:u})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=w?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,t=a.axisY.lineCoordinates,D=[],k=this.plotArea,m;f.save();w&&l.save();f.beginPath();f.rect(k.x1,k.y1,
k.width,k.height);f.clip();w&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],s=g.dataPoints,D=g.id;this._eventManager.objectMap[D]={objectType:"dataSeries",dataSeriesIndex:q};D=X(D);l.fillStyle=D;D=[];d=!0;var h=0,r,u,n,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),z,H=null;if(0<s.length){var C=g._colorSet[h%g._colorSet.length],v=g.lineColor=g.options.lineColor||C,
A=v;f.fillStyle=C;f.strokeStyle=v;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var L=J(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var S=J(c,g.lineThickness);f.setLineDash(S)}for(var ea=!0;h<s.length;h++)if(n=s[h].x.getTime?s[h].x.getTime():s[h].x,!(n<a.axisX.dataInfo.viewPortMin||n>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ea)))if("number"!==typeof s[h].y)g.connectNullData||(ea||d)||b(),ea=!0;else{r=a.axisX.convertValueToPixel(n);u=a.axisY.convertValueToPixel(s[h].y);
d||ea?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=r,c=u,r=m.x,u=m.y,b(),f.moveTo(m.x,m.y),r=d,u=c,H=m,c=g.nullDataLineDashType,f.setLineDash(L)),f.lineTo(r,u),w&&l.lineTo(r,u)):(f.beginPath(),f.moveTo(r,u),w&&(l.beginPath(),l.moveTo(r,u)),H={x:r,y:u}),ea=d=!1):(f.lineTo(r,u),w&&l.lineTo(r,u),0==h%250&&b());m={x:r,y:u};h<s.length-1&&(A!==(s[h].lineColor||v)||c!==(s[h].lineDashType||g.lineDashType))&&(b(),A=
s[h].lineColor||v,f.strokeStyle=A,f.setLineDash&&(s[h].lineDashType?(c=s[h].lineDashType,f.setLineDash(J(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(S))));var $=g.dataPointIds[h];this._eventManager.objectMap[$]={id:$,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:r,y1:u};0!==s[h].markerSize&&(0<s[h].markerSize||0<g.markerSize)&&(n=g.getMarkerProperties(h,r,u,f),D.push(n),$=X($),w&&D.push({x:r,y:u,ctx:l,type:n.type,size:n.size,color:$,borderColor:$,borderThickness:n.borderThickness}));
(s[h].indexLabel||g.indexLabel||s[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:s[h],dataSeries:g,point:{x:r,y:u},direction:0>s[h].y===a.axisY.reversed?1:-1,color:C})}b();W.drawMarkers(D)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
...
w&&(e.lineTo(c[c.length-1].x,n),e.lineTo(u.x,n),e.closePath(),e.fill())}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=a.axisY.lineCoordinates,l=[],t=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(t.x1,t.y1,t.width,t.height);b.clip();w&&(e.beginPath(),e.rect(t.x1,t.y1,t.width,t.height),e.clip());for(var h=0;h<a.dataSeriesIndexes.length;h++){var k=a.dataSeriesIndexes[h],m=this.data[k],p=m.dataPoints,
l=m.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:k};l=X(l);e.fillStyle=l;var l=[],q=0,g,s,r=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),n,u=null,y=[];if(0<p.length){var x=m._colorSet[q%m._colorSet.length],z=m.lineColor=m.options.lineColor||x,H=z;b.fillStyle=x;b.strokeStyle=z;b.lineWidth=m.lineThickness;var C="solid";if(b.setLineDash){var A=J(m.nullDataLineDashType,m.lineThickness),C=m.lineDashType,B=J(C,m.lineThickness);b.setLineDash(B)}for(s=
!1;q<p.length;q++)if(g=p[q].x.getTime?p[q].x.getTime():p[q].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!s)))if("number"!==typeof p[q].y)0<q&&!s&&(m.connectNullData?b.setLineDash&&(0<y.length&&(m.options.nullDataLineDashType||!p[q-1].lineDashType))&&(y[y.length-1].newLineDashArray=A,C=m.nullDataLineDashType):(d(),y=[])),s=!0;else{g=a.axisX.convertValueToPixel(g);s=a.axisY.convertValueToPixel(p[q].y);var L=m.dataPointIds[q];this._eventManager.objectMap[L]=
{id:L,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:g,y1:s};y[y.length]={x:g,y:s};q<p.length-1&&(H!==(p[q].lineColor||z)||C!==(p[q].lineDashType||m.lineDashType))&&(H=p[q].lineColor||z,y[y.length-1].newStrokeStyle=H,b.setLineDash&&(p[q].lineDashType?(C=p[q].lineDashType,y[y.length-1].newLineDashArray=J(C,m.lineThickness)):(C=m.lineDashType,y[y.length-1].newLineDashArray=B)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<m.markerSize)){var S=m.getMarkerProperties(q,g,s,b);l.push(S);
L=X(L);w&&l.push({x:g,y:s,ctx:e,type:S.type,size:S.size,color:L,borderColor:L,borderThickness:S.borderThickness})}(p[q].indexLabel||m.indexLabel||p[q].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[q],dataSeries:m,point:{x:g,y:s},direction:0>p[q].y===a.axisY.reversed?1:-1,color:x});s=!1}d();W.drawMarkers(l)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,
0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(t.x1,t.y1,t.width,t.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderStepArea=function(a){var d,c;function b(){H&&(0<g.lineThickness&&
f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?z=x:0>a.axisY.viewportMaximum?z=t.y1:0<a.axisY.viewportMinimum&&(z=x),f.lineTo(n,z),f.lineTo(H.x,z),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,w&&(l.lineTo(n,z),l.lineTo(H.x,z),l.closePath(),l.fill()),f.beginPath(),f.moveTo(n,u),l.beginPath(),l.moveTo(n,u),H={x:n,y:u})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=w?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,
t=a.axisY.lineCoordinates,h=[],k=this.plotArea,m;f.save();w&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();w&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],s=g.dataPoints,h=g.id;this._eventManager.objectMap[h]={objectType:"dataSeries",dataSeriesIndex:q};h=X(h);l.fillStyle=h;h=[];d=!0;var r=0,n,u,y,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),
z,H=null;c=!1;if(0<s.length){var C=g._colorSet[r%g._colorSet.length],v=g.lineColor=g.options.lineColor||C,A=v;f.fillStyle=C;f.strokeStyle=v;f.lineWidth=g.lineThickness;var L="solid";if(f.setLineDash){var S=J(g.nullDataLineDashType,g.lineThickness),L=g.lineDashType,B=J(L,g.lineThickness);f.setLineDash(B)}for(;r<s.length;r++)if(y=s[r].x.getTime?s[r].x.getTime():s[r].x,!(y<a.axisX.dataInfo.viewPortMin||y>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var $=u;"number"!==typeof s[r].y?(g.connectNullData||
(c||d)||b(),c=!0):(n=a.axisX.convertValueToPixel(y),u=a.axisY.convertValueToPixel(s[r].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||L===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=n,c=u,n=m.x,u=m.y,b(),f.moveTo(m.x,m.y),n=d,u=c,H=m,L=g.nullDataLineDashType,f.setLineDash(S)),f.lineTo(n,$),f.lineTo(n,u),w&&(l.lineTo(n,$),l.lineTo(n,u))):(f.beginPath(),f.moveTo(n,u),w&&(l.beginPath(),l.moveTo(n,u)),H={x:n,y:u}),c=d=!1):(f.lineTo(n,$),w&&l.lineTo(n,
$),f.lineTo(n,u),w&&l.lineTo(n,u),0==r%250&&b()),m={x:n,y:u},r<s.length-1&&(A!==(s[r].lineColor||v)||L!==(s[r].lineDashType||g.lineDashType))&&(b(),A=s[r].lineColor||v,f.strokeStyle=A,f.setLineDash&&(s[r].lineDashType?(L=s[r].lineDashType,f.setLineDash(J(L,g.lineThickness))):(L=g.lineDashType,f.setLineDash(B)))),y=g.dataPointIds[r],this._eventManager.objectMap[y]={id:y,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:r,x1:n,y1:u},0!==s[r].markerSize&&(0<s[r].markerSize||0<g.markerSize)&&($=
g.getMarkerProperties(r,n,u,f),h.push($),y=X(y),w&&h.push({x:n,y:u,ctx:l,type:$.type,size:$.size,color:y,borderColor:y,borderThickness:$.borderThickness})),(s[r].indexLabel||g.indexLabel||s[r].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:s[r],dataSeries:g,point:{x:n,y:u},direction:0>s[r].y===a.axisY.reversed?1:-1,color:C}))}b();W.drawMarkers(h)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",
...
function(a){function d(){if(!(1>k.length)){for(0<C.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&n.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=C.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(n.closePath(),n.fill(),n.beginPath());k=[]}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=[],t=this.plotArea,h=[],k=[],m=[],p=[],q=0,g,s,r=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:
0),n=this._eventManager.ghostCtx,u,y,x;w&&n.beginPath();b.save();w&&n.save();b.beginPath();b.rect(t.x1,t.y1,t.width,t.height);b.clip();w&&(n.beginPath(),n.rect(t.x1,t.y1,t.width,t.height),n.clip());for(var e=[],z=0;z<a.dataSeriesIndexes.length;z++){var H=a.dataSeriesIndexes[z],C=this.data[H],v=C.dataPoints;C.dataPointIndexes=[];for(q=0;q<v.length;q++)H=v[q].x.getTime?v[q].x.getTime():v[q].x,C.dataPointIndexes[H]=q,e[H]||(m.push(H),e[H]=!0);m.sort(Ra)}for(z=0;z<a.dataSeriesIndexes.length;z++){H=a.dataSeriesIndexes[z];
C=this.data[H];v=C.dataPoints;y=!0;k=[];q=C.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:H};q=X(q);n.fillStyle=q;if(0<m.length){var e=C._colorSet[0],A=C.lineColor=C.options.lineColor||e,L=A;b.fillStyle=e;b.strokeStyle=A;b.lineWidth=C.lineThickness;x="solid";if(b.setLineDash){var S=J(C.nullDataLineDashType,C.lineThickness);x=C.lineDashType;var B=J(x,C.lineThickness);b.setLineDash(B)}for(var $=!0,q=0;q<m.length;q++){var f=m[q],ga=null,ga=0<=C.dataPointIndexes[f]?v[C.dataPointIndexes[f]]:
{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!C.connectNullData||!$)))if("number"!==typeof ga.y)C.connectNullData||($||y)||d(),$=!0;else{g=a.axisX.convertValueToPixel(f);var na=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=ga.y+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;s=a.axisY.convertValueToPixel(p[f])}else s=a.axisY.convertValueToPixel(ga.y),s-=na;k.push({x:g,y:r-na});h[f]=r-s;y||$?(!y&&
C.connectNullData?(b.setLineDash&&(C.options.nullDataLineDashType||x===C.lineDashType&&C.lineDashType!==C.nullDataLineDashType)&&(y=k.pop(),x=k[k.length-1],d(),b.moveTo(u.x,u.y),k.push(x),k.push(y),x=C.nullDataLineDashType,b.setLineDash(S)),b.lineTo(g,s),w&&n.lineTo(g,s)):(b.beginPath(),b.moveTo(g,s),w&&(n.beginPath(),n.moveTo(g,s))),$=y=!1):(b.lineTo(g,s),w&&n.lineTo(g,s),0==q%250&&(d(),b.moveTo(g,s),w&&n.moveTo(g,s),k.push({x:g,y:r-na})));u={x:g,y:s};q<v.length-1&&(L!==(v[q].lineColor||A)||x!==
(v[q].lineDashType||C.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,s),k.push({x:g,y:r-na}),L=v[q].lineColor||A,b.strokeStyle=L,b.setLineDash&&(v[q].lineDashType?(x=v[q].lineDashType,b.setLineDash(J(x,C.lineThickness))):(x=C.lineDashType,b.setLineDash(B))));if(0<=C.dataPointIndexes[f]){var ka=C.dataPointIds[C.dataPointIndexes[f]];this._eventManager.objectMap[ka]={id:ka,objectType:"dataPoint",dataSeriesIndex:H,dataPointIndex:C.dataPointIndexes[f],x1:g,y1:s}}0<=C.dataPointIndexes[f]&&0!==ga.markerSize&&
(0<ga.markerSize||0<C.markerSize)&&(na=C.getMarkerProperties(C.dataPointIndexes[f],g,s,b),l.push(na),f=X(ka),w&&l.push({x:g,y:s,ctx:n,type:na.type,size:na.size,color:f,borderColor:f,borderThickness:na.borderThickness}));(ga.indexLabel||C.indexLabel||ga.indexLabelFormatter||C.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:ga,dataSeries:C,point:{x:g,y:s},direction:0>v[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,s);w&&n.moveTo(g,s)}delete C.dataPointIndexes}W.drawMarkers(l);
w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(t.x1,t.y1,t.width,t.height),n.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,
easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderStackedArea100=function(a){function d(){for(0<C.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&x.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=C.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(x.closePath(),x.fill(),x.beginPath());k=[]}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,t=[],h=[],k=[],m=[],p=[],q=
0,g,s,r,n,u,y=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),x=this._eventManager.ghostCtx;b.save();w&&x.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(x.beginPath(),x.rect(l.x1,l.y1,l.width,l.height),x.clip());for(var e=[],z=0;z<a.dataSeriesIndexes.length;z++){var H=a.dataSeriesIndexes[z],C=this.data[H],v=C.dataPoints;C.dataPointIndexes=[];for(q=0;q<v.length;q++)H=v[q].x.getTime?v[q].x.getTime():v[q].x,C.dataPointIndexes[H]=q,e[H]||(m.push(H),e[H]=
!0);m.sort(Ra)}for(z=0;z<a.dataSeriesIndexes.length;z++){H=a.dataSeriesIndexes[z];C=this.data[H];v=C.dataPoints;n=!0;e=C.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:H};e=X(e);x.fillStyle=e;k=[];if(0<m.length){var e=C._colorSet[q%C._colorSet.length],A=C.lineColor=C.options.lineColor||e,L=A;b.fillStyle=e;b.strokeStyle=A;b.lineWidth=C.lineThickness;u="solid";if(b.setLineDash){var S=J(C.nullDataLineDashType,C.lineThickness);u=C.lineDashType;var B=J(u,C.lineThickness);b.setLineDash(B)}for(var $=
!0,q=0;q<m.length;q++){var f=m[q],ga=null,ga=0<=C.dataPointIndexes[f]?v[C.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!C.connectNullData||!$)))if("number"!==typeof ga.y)C.connectNullData||($||n)||d(),$=!0;else{var na;na=0!==a.dataPointYSums[f]?100*(ga.y/a.dataPointYSums[f]):0;g=a.axisX.convertValueToPixel(f);var ka=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=na+(p[f]?p[f]:0);
if(0>=p[f]&&a.axisY.logarithmic)continue;s=a.axisY.convertValueToPixel(p[f])}else s=a.axisY.convertValueToPixel(na),s-=ka;k.push({x:g,y:y-ka});h[f]=y-s;n||$?(!n&&C.connectNullData?(b.setLineDash&&(C.options.nullDataLineDashType||u===C.lineDashType&&C.lineDashType!==C.nullDataLineDashType)&&(n=k.pop(),u=k[k.length-1],d(),b.moveTo(r.x,r.y),k.push(u),k.push(n),u=C.nullDataLineDashType,b.setLineDash(S)),b.lineTo(g,s),w&&x.lineTo(g,s)):(b.beginPath(),b.moveTo(g,s),w&&(x.beginPath(),x.moveTo(g,s))),$=n=
!1):(b.lineTo(g,s),w&&x.lineTo(g,s),0==q%250&&(d(),b.moveTo(g,s),w&&x.moveTo(g,s),k.push({x:g,y:y-ka})));r={x:g,y:s};q<v.length-1&&(L!==(v[q].lineColor||A)||u!==(v[q].lineDashType||C.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,s),k.push({x:g,y:y-ka}),L=v[q].lineColor||A,b.strokeStyle=L,b.setLineDash&&(v[q].lineDashType?(u=v[q].lineDashType,b.setLineDash(J(u,C.lineThickness))):(u=C.lineDashType,b.setLineDash(B))));if(0<=C.dataPointIndexes[f]){var F=C.dataPointIds[C.dataPointIndexes[f]];this._eventManager.objectMap[F]=
{id:F,objectType:"dataPoint",dataSeriesIndex:H,dataPointIndex:C.dataPointIndexes[f],x1:g,y1:s}}0<=C.dataPointIndexes[f]&&0!==ga.markerSize&&(0<ga.markerSize||0<C.markerSize)&&(ka=C.getMarkerProperties(q,g,s,b),t.push(ka),f=X(F),w&&t.push({x:g,y:s,ctx:x,type:ka.type,size:ka.size,color:f,borderColor:f,borderThickness:ka.borderThickness}));(ga.indexLabel||C.indexLabel||ga.indexLabelFormatter||C.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:ga,dataSeries:C,point:{x:g,
y:s},direction:0>v[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,s);w&&x.moveTo(g,s)}delete C.dataPointIndexes}W.drawMarkers(t);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
b.clearRect(l.x1,l.y1,l.width,l.height),x.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderBubble=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,f,l;c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(b.x1,b.y1,b.width,b.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),
...
s),k=0;k<a.dataSeriesIndexes.length;k++)if(m=a.dataSeriesIndexes[k],p=this.data[m],q=p.dataPoints,0<q.length)for(c.strokeStyle="#4572A7 ",e=0;e<q.length;e++)if(f=q[e].getTime?f=q[e].x.getTime():f=q[e].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof q[e].y){f=a.axisX.convertValueToPixel(f);l=a.axisY.convertValueToPixel(q[e].y);var g=q[e].z,n=2*Math.max(Math.sqrt((t===h?r/2:s+(r-s)/(t-h)*(g-h))/Math.PI)<<0,1),g=p.getMarkerProperties(e,c);g.size=n;c.globalAlpha=
p.fillOpacity;W.drawMarker(f,l,c,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;var u=p.dataPointIds[e];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:e,x1:f,y1:l,size:n};n=X(u);w&&W.drawMarker(f,l,this._eventManager.ghostCtx,g.type,g.size,n,n,g.borderThickness);(q[e].indexLabel||p.indexLabel||q[e].indexLabelFormatter||p.indexLabelFormatter)&&this._indexLabels.push({chartType:"bubble",dataPoint:q[e],dataSeries:p,point:{x:f,y:l},
...
f,l,c);c.globalAlpha=k.fillOpacity;W.drawMarker(g.x,g.y,g.ctx,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;Math.sqrt((p-f)*(p-f)+(q-l)*(q-l))<Math.min(g.size,5)&&m.length>Math.min(this.plotArea.width,this.plotArea.height)||(p=k.dataPointIds[e],this._eventManager.objectMap[p]={id:p,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:e,x1:f,y1:l},p=X(p),w&&W.drawMarker(g.x,g.y,this._eventManager.ghostCtx,g.type,g.size,p,p,g.borderThickness),(m[e].indexLabel||k.indexLabel||
...
this.dataPointMaxWidth&&e>f&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,f));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&f<e)&&(f=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));s<e&&(s=e);s>f&&(s=f);c.save();w&&b.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();w&&(b.beginPath(),b.rect(l.x1,l.y1,l.width,l.height),b.clip());for(var n=0;n<a.dataSeriesIndexes.length;n++){var ba=a.dataSeriesIndexes[n],u=this.data[ba],y=u.dataPoints;
if(0<y.length)for(var x=5<s&&u.bevelEnabled?!0:!1,t=0;t<y.length;t++)if(y[t].getTime?g=y[t].x.getTime():g=y[t].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!r(y[t].y)&&y[t].y.length&&"number"===typeof y[t].y[0]&&"number"===typeof y[t].y[1]&&"number"===typeof y[t].y[2]&&"number"===typeof y[t].y[3]){h=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(y[t].y[0]);m=a.axisY.convertValueToPixel(y[t].y[1]);p=a.axisY.convertValueToPixel(y[t].y[2]);q=a.axisY.convertValueToPixel(y[t].y[3]);
var z=h-s/2<<0,H=z+s<<0,f=u.options.fallingColor?u.fallingColor:u._colorSet[0],e=y[t].color?y[t].color:u._colorSet[0],C=Math.round(Math.max(1,0.15*s)),v=0===C%2?0:0.5,A=u.dataPointIds[t];this._eventManager.objectMap[A]={id:A,objectType:"dataPoint",dataSeriesIndex:ba,dataPointIndex:t,x1:z,y1:k,x2:H,y2:m,x3:h,y3:p,x4:h,y4:q,borderThickness:C,color:e};c.strokeStyle=e;c.beginPath();c.lineWidth=C;b.lineWidth=Math.max(C,4);"candlestick"===u.type?(c.moveTo(h-v,m),c.lineTo(h-v,Math.min(k,q)),c.stroke(),c.moveTo(h-
v,Math.max(k,q)),c.lineTo(h-v,p),c.stroke(),Y(c,z,Math.min(k,q),H,Math.max(k,q),y[t].y[0]<=y[t].y[3]?u.risingColor:f,C,e,x,x,!1,!1,u.fillOpacity),w&&(e=X(A),b.strokeStyle=e,b.moveTo(h-v,m),b.lineTo(h-v,Math.min(k,q)),b.stroke(),b.moveTo(h-v,Math.max(k,q)),b.lineTo(h-v,p),b.stroke(),Y(b,z,Math.min(k,q),H,Math.max(k,q),e,0,null,!1,!1,!1,!1))):"ohlc"===u.type&&(c.moveTo(h-v,m),c.lineTo(h-v,p),c.stroke(),c.beginPath(),c.moveTo(h,k),c.lineTo(z,k),c.stroke(),c.beginPath(),c.moveTo(h,q),c.lineTo(H,q),c.stroke(),
w&&(e=X(A),b.strokeStyle=e,b.moveTo(h-v,m),b.lineTo(h-v,p),b.stroke(),b.beginPath(),b.moveTo(h,k),b.lineTo(z,k),b.stroke(),b.beginPath(),b.moveTo(h,q),b.lineTo(H,q),b.stroke()));(y[t].indexLabel||u.indexLabel||y[t].indexLabelFormatter||u.indexLabelFormatter)&&this._indexLabels.push({chartType:u.type,dataPoint:y[t],dataSeries:u,point:{x:z+(H-z)/2,y:a.axisY.reversed?p:m},direction:1,bounds:{x1:z,y1:Math.min(m,p),x2:H,y2:Math.max(m,p)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,
...
b.rect(f.x1,f.y1,f.width,f.height),b.clip());for(var n=!1,n=!!a.axisY.reversed,ba=0;ba<a.dataSeriesIndexes.length;ba++){var u=a.dataSeriesIndexes[ba],y=this.data[u],x=y.dataPoints;if(0<x.length)for(var z=5<s&&y.bevelEnabled?!0:!1,l=0;l<x.length;l++)if(x[l].getTime?g=x[l].x.getTime():g=x[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!r(x[l].y)&&x[l].y.length&&"number"===typeof x[l].y[0]&&"number"===typeof x[l].y[1]&&"number"===typeof x[l].y[2]&&"number"===typeof x[l].y[3]&&
"number"===typeof x[l].y[4]&&5===x[l].y.length){t=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(x[l].y[0]);k=a.axisY.convertValueToPixel(x[l].y[1]);m=a.axisY.convertValueToPixel(x[l].y[2]);p=a.axisY.convertValueToPixel(x[l].y[3]);q=a.axisY.convertValueToPixel(x[l].y[4]);var v=t-s/2<<0,C=t+s/2<<0,e=x[l].color?x[l].color:y._colorSet[0],A=Math.round(Math.max(1,0.15*s)),B=0===A%2?0:0.5,L=x[l].whiskerColor?x[l].whiskerColor:x[l].color?y.whiskerColor?y.whiskerColor:x[l].color:y.whiskerColor?
y.whiskerColor:e,S="number"===typeof x[l].whiskerThickness?x[l].whiskerThickness:"number"===typeof y.options.whiskerThickness?y.whiskerThickness:A,ea=x[l].whiskerDashType?x[l].whiskerDashType:y.whiskerDashType,$=r(x[l].whiskerLength)?r(y.options.whiskerLength)?s:y.whiskerLength:x[l].whiskerLength,$="number"===typeof $?0>=$?0:$>=s?s:$:"string"===typeof $?parseInt($)*s/100>s?s:parseInt($)*s/100:s,ga=1===Math.round(S)%2?0.5:0,na=x[l].stemColor?x[l].stemColor:x[l].color?y.stemColor?y.stemColor:x[l].color:
y.stemColor?y.stemColor:e,ka="number"===typeof x[l].stemThickness?x[l].stemThickness:"number"===typeof y.options.stemThickness?y.stemThickness:A,F=1===Math.round(ka)%2?0.5:0,E=x[l].stemDashType?x[l].stemDashType:y.stemDashType,K=x[l].lineColor?x[l].lineColor:x[l].color?y.lineColor?y.lineColor:x[l].color:y.lineColor?y.lineColor:e,G="number"===typeof x[l].lineThickness?x[l].lineThickness:"number"===typeof y.options.lineThickness?y.lineThickness:A,O=x[l].lineDashType?x[l].lineDashType:y.lineDashType,
N=1===Math.round(G)%2?0.5:0,P=y.upperBoxColor,Q=y.lowerBoxColor,ta=r(y.options.fillOpacity)?1:y.fillOpacity,R=y.dataPointIds[l];this._eventManager.objectMap[R]={id:R,objectType:"dataPoint",dataSeriesIndex:u,dataPointIndex:l,x1:v,y1:h,x2:C,y2:k,x3:t,y3:m,x4:t,y4:p,y5:q,borderThickness:A,color:e,stemThickness:ka,stemColor:na,whiskerThickness:S,whiskerLength:$,whiskerColor:L,lineThickness:G,lineColor:K};c.save();0<ka&&(c.beginPath(),c.strokeStyle=na,c.lineWidth=ka,c.setLineDash&&c.setLineDash(J(E,ka)),
c.moveTo(t-F,k),c.lineTo(t-F,h),c.stroke(),c.moveTo(t-F,p),c.lineTo(t-F,m),c.stroke());c.restore();b.lineWidth=Math.max(A,4);c.beginPath();Y(c,v,Math.min(q,k),C,Math.max(k,q),Q,0,e,n?z:!1,n?!1:z,!1,!1,ta);c.beginPath();Y(c,v,Math.min(m,q),C,Math.max(q,m),P,0,e,n?!1:z,n?z:!1,!1,!1,ta);c.beginPath();c.lineWidth=A;c.strokeStyle=e;c.rect(v-B,Math.min(k,m)-B,C-v+2*B,Math.max(k,m)-Math.min(k,m)+2*B);c.stroke();c.save();0<G&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(J(O,G)),c.strokeStyle=
K,c.lineWidth=G,c.moveTo(v,q-N),c.lineTo(C,q-N),c.stroke());c.restore();c.save();0<S&&(c.beginPath(),c.setLineDash&&c.setLineDash(J(ea,S)),c.strokeStyle=L,c.lineWidth=S,c.moveTo(t-$/2<<0,p-ga),c.lineTo(t+$/2<<0,p-ga),c.stroke(),c.moveTo(t-$/2<<0,h+ga),c.lineTo(t+$/2<<0,h+ga),c.stroke());c.restore();w&&(e=X(R),b.strokeStyle=e,b.lineWidth=ka,0<ka&&(b.moveTo(t-B-F,k),b.lineTo(t-B-F,Math.max(h,p)),b.stroke(),b.moveTo(t-B-F,Math.min(h,p)),b.lineTo(t-B-F,m),b.stroke()),Y(b,v,Math.max(k,m),C,Math.min(k,
m),e,0,null,!1,!1,!1,!1),0<S&&(b.beginPath(),b.lineWidth=S,b.moveTo(t+$/2,p-ga),b.lineTo(t-$/2,p-ga),b.stroke(),b.moveTo(t+$/2,h+ga),b.lineTo(t-$/2,h+ga),b.stroke()));(x[l].indexLabel||y.indexLabel||x[l].indexLabelFormatter||y.indexLabelFormatter)&&this._indexLabels.push({chartType:y.type,dataPoint:x[l],dataSeries:y,point:{x:v+(C-v)/2,y:a.axisY.reversed?h:p},direction:1,bounds:{x1:v,y1:Math.min(h,p),x2:C,y2:Math.max(h,p)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
...
a.axisY.convertValueToPixel(g[f].y[0]);t=a.axisY.convertValueToPixel(g[f].y[1]);var n=a.axisX.reversed?b+a.plotType.totalDataSeries*k/2-(a.previousDataSeriesCount+m)*k<<0:b-a.plotType.totalDataSeries*k/2+(a.previousDataSeriesCount+m)*k<<0,ba=a.axisX.reversed?n-k<<0:n+k<<0,b=g[f].color?g[f].color:q._colorSet[f%q._colorSet.length];if(l>t){var u=l;l=t;t=u}u=q.dataPointIds[f];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:f,x1:n,y1:l,x2:ba,y2:t};Y(c,a.axisX.reversed?
ba:n,l,a.axisX.reversed?n:ba,t,b,0,b,s,s,!1,!1,q.fillOpacity);b=X(u);w&&Y(this._eventManager.ghostCtx,a.axisX.reversed?ba:n,l,a.axisX.reversed?n:ba,t,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:0,point:{x:n+(ba-n)/2,y:g[f].y[1]>=g[f].y[0]?t:l},direction:g[f].y[1]>=g[f].y[0]?-1:1,bounds:{x1:n,y1:Math.min(l,t),x2:ba,y2:Math.max(l,t)},color:b}),this._indexLabels.push({chartType:"rangeColumn",
dataPoint:g[f],dataSeries:q,indexKeyword:1,point:{x:n+(ba-n)/2,y:g[f].y[1]>=g[f].y[0]?l:t},direction:g[f].y[1]>=g[f].y[0]?1:-1,bounds:{x1:n,y1:Math.min(l,t),x2:ba,y2:Math.max(l,t)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
t=0,h,k,m,p,q,g,s,n=a.axisX.dataInfo.minDiff;isFinite(n)||(n=0.3*Math.abs(a.axisX.range));c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.clip());for(var ba=0,u=0;u<this.data.length;u++)!this.data[u].type.match(/(bar|column)/ig)||!this.data[u].visible||this.data[u].type.match(/(stacked)/ig)&&ba||ba++;for(var y=
...
1;t=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(C?ba:1)))<<0:0.3*this.width;f&&(t=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(C?ba:1)))<<0:0.03*this.width);u=this.options.dataPointWidth?this.dataPointWidth:0.9*((b?l.height:l.width)*(a.axisX.logarithmic?Math.log(n)/Math.log(a.axisX.range):
Math.abs(n)/Math.abs(a.axisX.range))/(C?ba:1))<<0;this.dataPointMaxWidth&&e>t&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,t));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&t<e)&&(t=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));u<e&&(u=e);u>t&&(u=t);if(0<v.length)for(var E=z._colorSet,t=0;t<v.length;t++){var e=z.lineColor=z.options.color?z.options.color:E[0],L={color:v[t].whiskerColor?v[t].whiskerColor:v[t].color?z.whiskerColor?z.whiskerColor:
...
!r(v[t].y)&&v[t].y.length&&"number"===typeof v[t].y[0]&&"number"===typeof v[t].y[1]){var ea=a.axisX.convertValueToPixel(s);b?k=ea:h=ea;ea=a.axisY.convertValueToPixel(v[t].y[0]);b?m=ea:q=ea;ea=a.axisY.convertValueToPixel(v[t].y[1]);b?p=ea:g=ea;b?(q=a.axisX.reversed?k+(C?ba:1)*u/2-(C?A-1:0)*u<<0:k-(C?ba:1)*u/2+(C?A-1:0)*u<<0,g=a.axisX.reversed?q-u<<0:q+u<<0):(m=a.axisX.reversed?h+(C?ba:1)*u/2-(C?A-1:0)*u<<0:h-(C?ba:1)*u/2+(C?A-1:0)*u<<0,p=a.axisX.reversed?m-u<<0:m+u<<0);!b&&q>g&&(ea=q,q=g,g=ea);b&&
m>p&&(ea=m,m=p,p=ea);ea=z.dataPointIds[t];this._eventManager.objectMap[ea]={id:ea,objectType:"dataPoint",dataSeriesIndex:x,dataPointIndex:t,x1:Math.min(m,p),y1:Math.min(q,g),x2:Math.max(p,m),y2:Math.max(g,q),isXYSwapped:b,stemProperties:S,whiskerProperties:L};B(c,Math.min(m,p),Math.min(q,g),Math.max(p,m),Math.max(g,q),e,L,S,b);w&&B(this._eventManager.ghostCtx,m,q,p,g,e,L,S,b);if(v[t].indexLabel||z.indexLabel||v[t].indexLabelFormatter||z.indexLabelFormatter)this._indexLabels.push({chartType:"error",
dataPoint:v[t],dataSeries:z,indexKeyword:0,point:{x:b?v[t].y[1]>=v[t].y[0]?m:p:m+(p-m)/2,y:b?q+(g-q)/2:v[t].y[1]>=v[t].y[0]?g:q},direction:v[t].y[1]>=v[t].y[0]?-1:1,bounds:{x1:b?Math.min(m,p):m,y1:b?q:Math.min(q,g),x2:b?Math.max(m,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b}),this._indexLabels.push({chartType:"error",dataPoint:v[t],dataSeries:z,indexKeyword:1,point:{x:b?v[t].y[1]>=v[t].y[0]?p:m:m+(p-m)/2,y:b?q+(g-q)/2:v[t].y[1]>=v[t].y[0]?q:g},direction:v[t].y[1]>=v[t].y[0]?1:-1,bounds:{x1:b?
Math.min(m,p):m,y1:b?q:Math.min(q,g),x2:b?Math.max(m,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(l.x1,l.y1,l.width,
l.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};n.prototype.renderRangeBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,t,h,k,f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;l=this.options.dataPointMaxWidth?
...
return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};n.prototype.renderRangeArea=function(a){function d(){if(y){for(var a=null,c=h.length-1;0<=c;c--)a=h[c],b.lineTo(a.x,a.y2),e.lineTo(a.x,a.y2);b.closePath();b.globalAlpha=m.fillOpacity;b.fill();b.globalAlpha=1;e.fill();if(0<m.lineThickness){b.beginPath();b.moveTo(a.x,a.y2);for(c=0;c<h.length;c++)a=h[c],b.lineTo(a.x,a.y2);b.moveTo(h[0].x,h[0].y1);for(c=0;c<h.length;c++)a=h[c],
b.lineTo(a.x,a.y1);b.stroke()}b.beginPath();b.moveTo(s,r);e.beginPath();e.moveTo(s,r);y={x:s,y:r};h=[];h.push({x:s,y1:r,y2:n})}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=[],k=a.dataSeriesIndexes[t],
m=this.data[k],p=m.dataPoints,f=m.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:k};f=X(f);e.fillStyle=f;var f=[],q=!0,g=0,s,r,n,u,y=null;if(0<p.length){var x=m._colorSet[g%m._colorSet.length],v=m.lineColor=m.options.lineColor||x,A=v;b.fillStyle=x;b.strokeStyle=v;b.lineWidth=m.lineThickness;var C="solid";if(b.setLineDash){var B=J(m.nullDataLineDashType,m.lineThickness),C=m.lineDashType,E=J(C,m.lineThickness);b.setLineDash(E)}for(var L=!0;g<p.length;g++)if(u=p[g].x.getTime?
p[g].x.getTime():p[g].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!L)))if(null!==p[g].y&&p[g].y.length&&"number"===typeof p[g].y[0]&&"number"===typeof p[g].y[1]){s=a.axisX.convertValueToPixel(u);r=a.axisY.convertValueToPixel(p[g].y[0]);n=a.axisY.convertValueToPixel(p[g].y[1]);q||L?(m.connectNullData&&!q?(b.setLineDash&&(m.options.nullDataLineDashType||C===m.lineDashType&&m.lineDashType!==m.nullDataLineDashType)&&(h[h.length-1].newLineDashArray=E,C=m.nullDataLineDashType,
b.setLineDash(B)),b.lineTo(s,r),w&&e.lineTo(s,r),h.push({x:s,y1:r,y2:n})):(b.beginPath(),b.moveTo(s,r),y={x:s,y:r},h=[],h.push({x:s,y1:r,y2:n}),w&&(e.beginPath(),e.moveTo(s,r))),L=q=!1):(b.lineTo(s,r),h.push({x:s,y1:r,y2:n}),w&&e.lineTo(s,r),0==g%250&&d());u=m.dataPointIds[g];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:g,x1:s,y1:r,y2:n};g<p.length-1&&(A!==(p[g].lineColor||v)||C!==(p[g].lineDashType||m.lineDashType))&&(d(),A=p[g].lineColor||v,h[h.length-
1].newStrokeStyle=A,b.strokeStyle=A,b.setLineDash&&(p[g].lineDashType?(C=p[g].lineDashType,h[h.length-1].newLineDashArray=J(C,m.lineThickness),b.setLineDash(h[h.length-1].newLineDashArray)):(C=m.lineDashType,h[h.length-1].newLineDashArray=E,b.setLineDash(E))));if(0!==p[g].markerSize&&(0<p[g].markerSize||0<m.markerSize)){var S=m.getMarkerProperties(g,s,n,b);f.push(S);var ea=X(u);w&&f.push({x:s,y:n,ctx:e,type:S.type,size:S.size,color:ea,borderColor:ea,borderThickness:S.borderThickness});S=m.getMarkerProperties(g,
s,r,b);f.push(S);ea=X(u);w&&f.push({x:s,y:r,ctx:e,type:S.type,size:S.size,color:ea,borderColor:ea,borderThickness:S.borderThickness})}if(p[g].indexLabel||m.indexLabel||p[g].indexLabelFormatter||m.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:m,indexKeyword:0,point:{x:s,y:r},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?-1:1,color:x}),this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:m,indexKeyword:1,point:{x:s,y:n},direction:p[g].y[0]>
p[g].y[1]===a.axisY.reversed?1:-1,color:x})}else L||q||d(),L=!0;d();W.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.restore());
...
d[f].newLineDashArray&&b.setLineDash(d[f].newLineDashArray);b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y)}}b.beginPath();b.moveTo(d[0].x,d[0].y);w&&(e.beginPath(),e.moveTo(d[0].x,d[0].y));for(f=0;f<d.length-3;f+=3)b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y),w&&e.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y);d=v(ba,2);b.lineTo(ba[ba.length-1].x,ba[ba.length-1].y);for(f=d.length-1;2<f;f-=3)b.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-
2].x,d[f-2].y,d[f-3].x,d[f-3].y),w&&e.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y);b.closePath();b.globalAlpha=k.fillOpacity;b.fill();w&&(e.closePath(),e.fill());b.globalAlpha=1;if(0<k.lineThickness){b.strokeStyle=c;b.setLineDash&&b.setLineDash(a);b.beginPath();b.moveTo(d[0].x,d[0].y);for(var g=f=0;f<d.length-3;f+=3,g++){if(n[g].newStrokeStyle||n[g].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(d[f].x,d[f].y),n[g].newStrokeStyle&&(b.strokeStyle=n[g].newStrokeStyle),n[g].newLineDashArray&&
...
this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var h=0;h<a.dataSeriesIndexes.length;h++){var r=a.dataSeriesIndexes[h],k=this.data[r],m=k.dataPoints,f=k.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:r};f=X(f);e.fillStyle=f;var f=[],p=0,q,
g,s,n=[],ba=[];if(0<m.length){var u=k._colorSet[p%k._colorSet.length],y=k.lineColor=k.options.lineColor||u,x=y;b.fillStyle=u;b.lineWidth=k.lineThickness;var z="solid",A;if(b.setLineDash){var C=J(k.nullDataLineDashType,k.lineThickness),z=k.lineDashType;A=J(z,k.lineThickness)}for(g=!1;p<m.length;p++)if(q=m[p].x.getTime?m[p].x.getTime():m[p].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!g)))if(null!==m[p].y&&m[p].y.length&&"number"===typeof m[p].y[0]&&"number"===
typeof m[p].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(m[p].y[0]);s=a.axisY.convertValueToPixel(m[p].y[1]);var B=k.dataPointIds[p];this._eventManager.objectMap[B]={id:B,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:p,x1:q,y1:g,y2:s};n[n.length]={x:q,y:g};ba[ba.length]={x:q,y:s};p<m.length-1&&(x!==(m[p].lineColor||y)||z!==(m[p].lineDashType||k.lineDashType))&&(x=m[p].lineColor||y,n[n.length-1].newStrokeStyle=x,b.setLineDash&&(m[p].lineDashType?(z=m[p].lineDashType,
n[n.length-1].newLineDashArray=J(z,k.lineThickness)):(z=k.lineDashType,n[n.length-1].newLineDashArray=A)));if(0!==m[p].markerSize&&(0<m[p].markerSize||0<k.markerSize)){var G=k.getMarkerProperties(p,q,g,b);f.push(G);var L=X(B);w&&f.push({x:q,y:g,ctx:e,type:G.type,size:G.size,color:L,borderColor:L,borderThickness:G.borderThickness});G=k.getMarkerProperties(p,q,s,b);f.push(G);L=X(B);w&&f.push({x:q,y:s,ctx:e,type:G.type,size:G.size,color:L,borderColor:L,borderThickness:G.borderThickness})}if(m[p].indexLabel||
k.indexLabel||m[p].indexLabelFormatter||k.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:m[p],dataSeries:k,indexKeyword:0,point:{x:q,y:g},direction:m[p].y[0]<=m[p].y[1]?-1:1,color:u}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:m[p],dataSeries:k,indexKeyword:1,point:{x:q,y:s},direction:m[p].y[0]<=m[p].y[1]?1:-1,color:u});g=!1}else 0<p&&!g&&(k.connectNullData?b.setLineDash&&(0<n.length&&(k.options.nullDataLineDashType||!m[p-1].lineDashType))&&(n[n.length-
1].newLineDashArray=C,z=k.nullDataLineDashType):(d(A,y),n=[],ba=[])),g=!0;d(A,y);W.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),
...
this.options.dataPointWidth?this.dataPointWidth:1;r=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.width,0.9*(this.plotArea.width/a.plotType.totalDataSeries))<<0;var q=a.axisX.dataInfo.minDiff;isFinite(q)||(q=0.3*Math.abs(a.axisX.range));q=this.options.dataPointWidth?this.dataPointWidth:0.6*(f.width*(a.axisX.logarithmic?Math.log(q)/Math.log(a.axisX.range):Math.abs(q)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&
l>r&&(l=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,r));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&r<l)&&(r=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,l));q<l&&(q=l);q>r&&(q=r);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(f.x1,f.y1,f.width,f.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(f.x1,f.y1,f.width,f.height),this._eventManager.ghostCtx.clip());for(var g=0;g<a.dataSeriesIndexes.length;g++){var s=
a.dataSeriesIndexes[g],n=this.data[s],v=n.dataPoints,e=n._colorSet[0];n.risingColor=n.options.risingColor?n.options.risingColor:e;n.fallingColor=n.options.fallingColor?n.options.fallingColor:"#e40a0a";var u="number"===typeof n.options.lineThickness?Math.round(n.lineThickness):1,y=1===Math.round(u)%2?-0.5:0;if(0<v.length)for(var x=5<q&&n.bevelEnabled?!0:!1,z=!1,A=null,C=null,l=0;l<v.length;l++)if(v[l].getTime?m=v[l].x.getTime():m=v[l].x,"number"!==typeof v[l].y){if(0<l&&!z&&n.connectNullData)var B=
n.options.nullDataLineDashType||!v[l-1].lineDashType?n.nullDataLineDashType:v[l-1].lineDashType;z=!0}else{h=a.axisX.convertValueToPixel(m);r=0===n.dataPointEOs[l].cumulativeSum?p:a.axisY.convertValueToPixel(n.dataPointEOs[l].cumulativeSum);k=0===n.dataPointEOs[l].cumulativeSumYStartValue?p:a.axisY.convertValueToPixel(n.dataPointEOs[l].cumulativeSumYStartValue);h=a.axisX.reversed?h+a.plotType.totalDataSeries*q/2-(a.previousDataSeriesCount+g)*q<<0:h-a.plotType.totalDataSeries*q/2+(a.previousDataSeriesCount+
g)*q<<0;var E=a.axisX.reversed?h-q<<0:h+q<<0;r>k&&(e=r,r=k,k=e);a.axisY.reversed&&(e=r,r=k,k=e);e=n.dataPointIds[l];this._eventManager.objectMap[e]={id:e,objectType:"dataPoint",dataSeriesIndex:s,dataPointIndex:l,x1:h,y1:r,x2:E,y2:k};var L=v[l].color?v[l].color:0<v[l].y?n.risingColor:n.fallingColor;Y(c,a.axisX.reversed?E:h,a.axisY.reversed?k:r,a.axisX.reversed?h:E,a.axisY.reversed?r:k,L,0,L,x,x,!1,!1,n.fillOpacity);e=X(e);w&&Y(this._eventManager.ghostCtx,a.axisX.reversed?E:h,r,a.axisX.reversed?h:E,
k,e,0,null,!1,!1,!1,!1);var S,L=h;S="undefined"!==typeof v[l].isIntermediateSum&&!0===v[l].isIntermediateSum||"undefined"!==typeof v[l].isCumulativeSum&&!0===v[l].isCumulativeSum?0<v[l].y?r:k:0<v[l].y?k:r;0<l&&A&&(!z||n.connectNullData)&&(z&&c.setLineDash&&c.setLineDash(J(B,u)),c.beginPath(),c.moveTo(A,C-y),c.lineTo(L,S-y),0<u&&c.stroke(),w&&(b.beginPath(),b.moveTo(A,C-y),b.lineTo(L,S-y),0<u&&b.stroke()));z=!1;A=E;C=0<v[l].y?r:k;L=v[l].lineDashType?v[l].lineDashType:n.options.lineDashType?n.options.lineDashType:
"shortDash";c.strokeStyle=v[l].lineColor?v[l].lineColor:n.options.lineColor?n.options.lineColor:"#9e9e9e";c.lineWidth=u;c.setLineDash&&(L=J(L,u),c.setLineDash(L));(v[l].indexLabel||n.indexLabel||v[l].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"waterfall",dataPoint:v[l],dataSeries:n,point:{x:h+(E-h)/2,y:0<=v[l].y?r:k},direction:0>v[l].y===a.axisY.reversed?1:-1,bounds:{x1:h,y1:Math.min(r,k),x2:E,y2:Math.max(r,k)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,
...
f.indexLabel?n.replaceKeywordsWithValue(f.indexLabel,f,k,e):k.indexLabelFormatter?k.indexLabelFormatter(t):k.indexLabel?n.replaceKeywordsWithValue(k.indexLabel,f,k,e):f.label?f.label:"";n._eventManager.objectMap[l]=h;h.center={x:x.x,y:x.y};h.y=f.y;h.radius=C;h.percentInnerRadius=E;h.indexLabelText=p;h.indexLabelPlacement=k.indexLabelPlacement;h.indexLabelLineColor=f.indexLabelLineColor?f.indexLabelLineColor:k.options.indexLabelLineColor?k.options.indexLabelLineColor:f.color?f.color:k._colorSet[e%
...
g[a];h.indexLabelTextBlock.x=x.x+w*Math.cos(h.midAngle);h.indexLabelTextBlock.y=x.y+w*Math.sin(h.midAngle);h.indexLabelAngle=h.midAngle;h.radius=C;h.percentInnerRadius=E}for(var t,r,a=0;a<m.length;a++){var h=g[a],u=e(a);if(null!==u){t=g[a];r=g[u];var z=0,z=b(t,r)-s;if(0>z){for(var A=r=0,H=0;H<m.length;H++)H!==a&&g[H].hemisphere===h.hemisphere&&(g[H].indexLabelTextBlock.y<h.indexLabelTextBlock.y?r++:A++);r=z/(r+A||1)*A;var A=-1*(z-r),J=H=0;"right"===h.hemisphere?(H=f(a,r),A=-1*(z-H),J=f(u,A),+J.toFixed(y)<
+A.toFixed(y)&&+H.toFixed(y)<=+r.toFixed(y)&&f(a,-(A-J))):(H=f(u,r),A=-1*(z-H),J=f(a,A),+J.toFixed(y)<+A.toFixed(y)&&+H.toFixed(y)<=+r.toFixed(y)&&f(u,-(A-J)))}}}}else for(a=0;a<m.length;a++)h=g[a],w="pie"===k.type?0.7*C:0.85*C,u=x.x+w*Math.cos(h.midAngle),r=x.y+w*Math.sin(h.midAngle),h.indexLabelTextBlock.x=u,h.indexLabelTextBlock.y=r;for(a=0;a<m.length;a++)if(h=g[a],u=h.indexLabelTextBlock.measureText(),0!==u.height&&0!==u.width)u=u=0,"right"===h.hemisphere?(u=q.x2-(h.indexLabelTextBlock.x+h.indexLabelTextBlock.width+
...
b,c){for(var d=[],e=0;d.push(g[b]),b!==c;b=(b+1+m.length)%m.length);d.sort(function(a,b){return a.y-b.y});for(b=0;b<d.length;b++)if(c=d[b],e<0.7*a)e+=c.indexLabelTextBlock.height,c.indexLabelTextBlock.text="",c.indexLabelText="",c.indexLabelTextBlock.measureText();else break};(function(){for(var a=-1,c=-1,d=0,f=!1,k=0;k<m.length;k++)if(f=!1,t=g[k],t.indexLabelText){var l=e(k);if(null!==l){var h=g[l];z=0;z=b(t,h);var q;if(q=0>z){q=t.indexLabelTextBlock.x;var n=t.indexLabelTextBlock.y-t.indexLabelTextBlock.height/
2,s=t.indexLabelTextBlock.y+t.indexLabelTextBlock.height/2,r=h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2,u=h.indexLabelTextBlock.x+h.indexLabelTextBlock.width,D=h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2;q=t.indexLabelTextBlock.x+t.indexLabelTextBlock.width<h.indexLabelTextBlock.x-p||q>u+p||n>D+p||s<r-p?!1:!0}q?(0>a&&(a=k),l!==a&&(c=l,d+=-z),0===k%Math.max(m.length/10,3)&&(f=!0)):f=!0;f&&(0<d&&0<=a&&0<=c)&&(G(d,a,c),c=a=-1,d=0)}}0<d&&G(d,a,c)})()}}function h(){n.plotArea.layoutManager.reset();
...
"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof u.indexLabelWrap?u.indexLabelWrap:!0;t=u.dataPointIds[C];A._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataPointIndex:C,dataSeriesIndex:0,funnelSection:R[u.reversed?y.length-1-C:C]};"inside"===u.indexLabelPlacement&&(D[C]=C!==ca?u.reversed?R[C].x2-R[C].x1:R[C].x3-R[C].x4:R[C].x3-R[C].x6,20>D[C]&&(D[C]=C!==ca?u.reversed?R[C].x3-R[C].x4:R[C].x2-R[C].x1:R[C].x2-R[C].x1,D[C]/=2));t=b.indexLabelMaxWidth?b.indexLabelMaxWidth:
...
c,d;if("inside"!==u.indexLabelPlacement)for(var e=0;e<R.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=R[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=u.reversed?"undefined"!==typeof a.x5?c>Ca?g(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<Ca?g(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,I[e].textBlock.x=b+X,I[e].textBlock.y=c-I[e].height/2,u.reversed?(I[e].textBlock.y+I[e].height>U+z&&(I[e].textBlock.y=U+z-I[e].height),I[e].textBlock.y<ta-z&&(I[e].textBlock.y=
...
va.fNg&&va.fNg(A)}var A=this;if(!(0>=a.dataSeriesIndexes.length)){for(var u=this.data[a.dataSeriesIndexes[0]],y=u.dataPoints,x=this.plotArea,z=0.025*x.width,B=0.01*x.width,C=0,E=x.height-2*z,G=Math.min(x.width-2*B,2.8*x.height),L=!1,S=0;S<y.length;S++)if(!L&&("undefined"!==typeof y[S].indexLabel&&null!==y[S].indexLabel&&0<y[S].indexLabel.toString().length)&&(L=!0),!L&&("undefined"!==typeof y[S].label&&null!==y[S].label&&0<y[S].label.toString().length)&&(L=!0),!L&&"function"===typeof u.indexLabelFormatter||
"function"===typeof y[S].indexLabelFormatter)L=!0;L=L||"undefined"!==typeof u.indexLabel&&null!==u.indexLabel&&0<u.indexLabel.toString().length;"inside"!==u.indexLabelPlacement&&L||(B=(x.width-0.75*G)/2);var S=x.x1+B,K=x.x2-B,$=x.y1+z,O=x.y2-z,P=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=u.length&&(u.dataPoints&&u.visible)&&0!==y.length){var Q,F;a=75*G/100;var X=30*(K-a)/100;"funnel"===u.type?(Q=r(u.options.neckHeight)?0.35*E:u.neckHeight,F=r(u.options.neckWidth)?0.25*a:u.neckWidth,"string"===
typeof Q&&Q.match(/%$/)?(Q=parseInt(Q),Q=Q*E/100):Q=parseInt(Q),"string"===typeof F&&F.match(/%$/)?(F=parseInt(F),F=F*a/100):F=parseInt(F),Q>E?Q=E:0>=Q&&(Q=0),F>a?F=a-0.5:0>=F&&(F=0)):"pyramid"===u.type&&(F=Q=0,u.reversed=u.reversed?!1:!0);var B=S+a/2,T=S,V=S+a,U=u.reversed?O:$,N=B-F/2,W=B+F/2,Ca=u.reversed?$+Q:O-Q,ta=u.reversed?$:O;a=[];var B=[],R=[],G=[],Y=$,ca,aa=(Ca-U)/(N-T),fa=-aa,S="area"===(u.valueRepresents?u.valueRepresents:"height")?c():d();if(-1!==S){if(u.reversed)for(G.push(Y),F=S.length-
1;0<F;F--)Y+=S[F],G.push(Y);else for(F=0;F<S.length;F++)Y+=S[F],G.push(Y);if(u.reversed)for(F=0;F<S.length;F++)G[F]<Ca?(a.push(N),B.push(W),ca=F):(a.push((G[F]-U+aa*T)/aa),B.push((G[F]-U+fa*V)/fa));else for(F=0;F<S.length;F++)G[F]<Ca?(a.push((G[F]-U+aa*T)/aa),B.push((G[F]-U+fa*V)/fa),ca=F):(a.push(N),B.push(W));for(F=0;F<S.length-1;F++)Y=u.reversed?y[y.length-1-F].color?y[y.length-1-F].color:u._colorSet[(y.length-1-F)%u._colorSet.length]:y[F].color?y[F].color:u._colorSet[F%u._colorSet.length],F===
ca?R.push({x1:a[F],y1:G[F],x2:B[F],y2:G[F],x3:W,y3:Ca,x4:B[F+1],y4:G[F+1],x5:a[F+1],y5:G[F+1],x6:N,y6:Ca,id:F,height:G[F+1]-G[F],color:Y}):R.push({x1:a[F],y1:G[F],x2:B[F],y2:G[F],x3:B[F+1],y3:G[F+1],x4:a[F+1],y4:G[F+1],id:F,height:G[F+1]-G[F],color:Y});var da=2,I=[],ha=!1,Z=[],ia=[],S=!1;a=a=0;Ea(Z);for(F=0;F<y.length;F++)y[F].exploded&&(S=!0,u.reversed?Z.push(y.length-1-F):Z.push(F));P.clearRect(x.x1,x.y1,x.width,x.height);P.fillStyle=A.backgroundColor;P.fillRect(x.x1,x.y1,x.width,x.height);if(L&&
...
return"x"===a?(c.axisX&&"dateTime"===c.axisX.valueType||"dateTime"===c.xValueType||d.x&&d.x.getTime)&&!c.axisX.logarithmic?Ba(g,d.xValueFormatString?d.xValueFormatString:c.xValueFormatString?c.xValueFormatString:c.xValueFormatString=f.axisX&&f.axisX.autoValueFormatString?f.axisX.autoValueFormatString:"DD MMM YY",f._cultureInfo):da(g,d.xValueFormatString?d.xValueFormatString:c.xValueFormatString?c.xValueFormatString:c.xValueFormatString="#,##0.########",f._cultureInfo):"y"===a?da(g,d.yValueFormatString?
d.yValueFormatString:c.yValueFormatString?c.yValueFormatString:c.yValueFormatString="#,##0.########",f._cultureInfo):"z"===a?da(g,d.zValueFormatString?d.zValueFormatString:c.zValueFormatString?c.zValueFormatString:c.zValueFormatString="#,##0.########",f._cultureInfo):g})};oa(K,G);K.prototype.setLayout=function(){var a=this.dockInsidePlotArea?this.chart.plotArea:this.chart,d=a.layoutManager.getFreeSpace(),c=null,b=0,e=0,f=0,l=0,h=this.markerMargin=this.chart.options.legend&&!r(this.chart.options.legend.markerMargin)?
...
"error"===p.type&&p._linkedSeries?p._linkedSeries.legendMarkerType?p._linkedSeries.legendMarkerType:Q.getDefaultLegendMarker(p._linkedSeries.type):Q.getDefaultLegendMarker(p.type):p.markerType,g=p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:null}):p.name,s=p.legendMarkerColor=p.legendMarkerColor?p.legendMarkerColor:p.markerColor?p.markerColor:"error"===p.type?r(p.whiskerColor)?p._colorSet[0]:p.whiskerColor:p._colorSet[0],
w=p.markerSize||"line"!==p.type&&"stepLine"!==p.type&&"spline"!==p.type?0.75*this.lineHeight:0,v=p.legendMarkerBorderColor?p.legendMarkerBorderColor:p.markerBorderColor,u=p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:p.markerBorderThickness?Math.max(1,Math.round(0.2*w)):0;"error"===p.type&&this.errorMarkerColor.push(s);g=this.chart.replaceKeywordsWithValue(g,p.dataPoints[0],p,m);q={markerType:q,markerColor:s,text:g,textBlock:null,chartType:p.type,markerSize:w,lineColor:p._colorSet[0],
dataSeriesIndex:p.index,dataPointIndex:null,markerBorderColor:v,markerBorderThickness:u};n.push(q)}else for(var y=0;y<p.dataPoints.length;y++){var x=p.dataPoints[y],q=x.legendMarkerType?x.legendMarkerType:p.legendMarkerType?p.legendMarkerType:Q.getDefaultLegendMarker(p.type),g=x.legendText?x.legendText:p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:x}):x.name?x.name:"DataPoint: "+(y+1),s=x.legendMarkerColor?x.legendMarkerColor:
...
x,p,y),q={markerType:q,markerColor:s,text:g,textBlock:null,chartType:p.type,markerSize:w,dataSeriesIndex:m,dataPointIndex:y,markerBorderColor:v,markerBorderThickness:u};(x.showInLegend||p.showInLegend&&!1!==x.showInLegend)&&n.push(q)}}!0===this.reversed&&n.reverse();if(0<n.length){p=null;s=g=x=y=0;x=null!==this.itemWidth?null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,f):this.itemMaxWidth=Math.min(this.itemWidth,f):null!==this.itemMaxWidth?Math.min(this.itemMaxWidth,f):this.itemMaxWidth=
...
width:0},k.push(p)):(p=k[y],y=(y+1)%k.length),this.height+=q.textBlock.height;q.textBlock.x=p.width;q.textBlock.y=0;p.width+=Math.round(q.textBlock.width+w+h+(0===p.width?0:this.horizontalSpacing)+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0));p.items.push(q);this.width=Math.max(p.width,this.width);s=q.textBlock.width+(w+h+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))}}this.itemWidth=s;this.height=
...
s=d+h,r=g;this.chart.data[q.dataSeriesIndex].visible||(this.ctx.globalAlpha=0.5);this.ctx.save();this.ctx.beginPath();this.ctx.rect(a,d,b,Math.max(e-e%this.lineHeight,0));this.ctx.clip();if("line"===q.chartType||"stepLine"===q.chartType||"spline"===q.chartType)this.ctx.strokeStyle=q.lineColor,this.ctx.lineWidth=Math.ceil(this.lineHeight/8),this.ctx.beginPath(),this.ctx.moveTo(g-0.1*this.lineHeight,s+this.lineHeight/2),this.ctx.lineTo(g+0.85*this.lineHeight,s+this.lineHeight/2),this.ctx.stroke(),r-=
0.1*this.lineHeight;if("error"===q.chartType){this.ctx.strokeStyle=this.errorMarkerColor[0];this.ctx.lineWidth=f/8;this.ctx.beginPath();var w=g-0.08*this.lineHeight+0.1*this.lineHeight,u=s+0.15*this.lineHeight,y=0.7*this.lineHeight,x=y+0.02*this.lineHeight;this.ctx.moveTo(w,u);this.ctx.lineTo(w+y,u);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(w+y/2,u);this.ctx.lineTo(w+y/2,u+x);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(w,u+x);this.ctx.lineTo(w+y,u+x);this.ctx.stroke();this.errorMarkerColor.shift()}W.drawMarker(g+
f/2,s+this.lineHeight/2,this.ctx,q.markerType,"error"===q.chartType||"line"===q.chartType||"spline"===q.chartType?q.markerSize/2:q.markerSize,q.markerColor,q.markerBorderColor,q.markerBorderThickness);q.textBlock.x=g+c+f;if("line"===q.chartType||"stepLine"===q.chartType||"spline"===q.chartType)q.textBlock.x+=0.1*this.lineHeight;q.textBlock.y=Math.round(s+this.lineHeight/2);q.textBlock.render(!0);this.ctx.restore();m=0<p?Math.max(m,q.textBlock.height):q.textBlock.height;this.chart.data[q.dataSeriesIndex].visible||
(this.ctx.globalAlpha=1);g=X(q.id);this.ghostCtx.fillStyle=g;this.ghostCtx.beginPath();this.ghostCtx.fillRect(r,q.textBlock.y-this.lineHeight/2,q.textBlock.x+q.textBlock.width-r,q.textBlock.height);q.x1=this.chart._eventManager.objectMap[q.id].x1=r;q.y1=this.chart._eventManager.objectMap[q.id].y1=q.textBlock.y-this.lineHeight/2;q.x2=this.chart._eventManager.objectMap[q.id].x2=q.textBlock.x+q.textBlock.width;q.y2=this.chart._eventManager.objectMap[q.id].y2=q.textBlock.y+q.textBlock.height-this.lineHeight/
2}h+=m}};oa(Q,G);Q.prototype.getDefaultAxisPlacement=function(){var a=this.type;if("column"===a||"line"===a||"stepLine"===a||"spline"===a||"area"===a||"stepArea"===a||"splineArea"===a||"stackedColumn"===a||"stackedLine"===a||"bubble"===a||"scatter"===a||"stackedArea"===a||"stackedColumn100"===a||"stackedLine100"===a||"stackedArea100"===a||"candlestick"===a||"ohlc"===a||"rangeColumn"===a||"rangeArea"===a||"rangeSplineArea"===a||"boxAndWhisker"===a||"waterfall"===a)return"normal";if("bar"===a||"stackedBar"===
...
"cross"===b&&(c.strokeStyle=f,c.lineWidth=e/4,c.beginPath(),c.moveTo(a-e/2,d-e/2),c.lineTo(a+e/2,d+e/2),c.stroke(),c.moveTo(a+e/2,d-e/2),c.lineTo(a-e/2,d+e/2),c.stroke())}},drawMarkers:function(a){for(var d=0;d<a.length;d++){var c=a[d];W.drawMarker(c.x,c.y,c.ctx,c.type,c.size,c.color,c.borderColor,c.borderThickness)}}};return n}();B.version="v3.7.21 GA";window.CanvasJS&&(B&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=B)})();
